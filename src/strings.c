...
const u8 gText_Boy[] = _("Red");
const u8 gText_Girl[] = _("Leaf");
...
const u8 gText_ItemfinderShakingWildly[] = _("Oh! The Dowsing Machine\nis shaking wildly!\pThere's an item buried underfoot!\p‥ ‥ ‥ ‥ ‥ ‥{PAUSE_UNTIL_PRESS}");
...
const u8 gText_Browt[] = _("Browt");
const u8 gText_Pombon[] = _("Pombon");
const u8 gText_Gecqua[] = _("Gecqua");
const u8 gText_WhoAreYou[] = _("Who are you?");
const u8 gText_SorryIllLeave[] = _("Sorry, I'll leave.");
const u8 gText_Music[] = _("Music");
const u8 gText_NatDex2[] = _("Nat. Dex 2");
const u8 gText_Gen10[] = _("Gen 10");
const u8 gText_SpeakJapanese[] = _("Speak Japanese");
const u8 gText_Nothing[] = _("Nothing");
const u8 gText_LovedThem[] = _("Loved them");
const u8 gText_HatedThem[] = _("Hated them");
const u8 gText_HaventSeen[] = _("Haven't seen");
...
const u8 gText_RegionMap_AreaDesc_VictoryRoad[] = _("A tunnel situated on Routes 23.\nIt earned its name because it\nmust be traveled by all Trainers\naiming for the top.");
...
const u8 gText_SoundMono[] = _("Off");
const u8 gText_SoundStereo[] = _("On");
const u8 gText_BattleBGMDefault[] = _("Default");
const u8 gText_BattleBGMContextualRandom[] = _("Contextual Random");
const u8 gText_BattleBGMPureRandom[] = _("Pure Random");
const u8 gTextJP_Type[] = _("タイプ");
const u8 gText_ButtonTypeLEqualsA[] = _("Modern");
const u8 gText_ButtonTypeLR[] = _("Classic");
...
const u8 gText_Counting_1[] = _("One…");
const u8 gText_Counting_2And[] = _("two…and…");
const u8 gText_Poof[] = _("ta-da!\p");
...
const u8 gText_1_2_and_Poof[] = _("{PAUSE 0x20}One…{PAUSE 20}two…{PAUSE 20}and…{PAUSE 38}{PLAY_SE SE_BALL_BOUNCE_1}ta-da!\p");
