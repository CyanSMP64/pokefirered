...
static const u8 sText_PlayerPaidAsPrizeMoney[] = _("You gave ¥{B_BUFF1} to the winner…\pYou were overwhelmed by your\ndefeat!{PAUSE_UNTIL_PRESS}");
static const u8 sText_PlayerWhiteout2[] = _("You were overwhelmed by your\ndefeat!{PAUSE_UNTIL_PRESS}");
