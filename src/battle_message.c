...
static const u8 sText_Trainer1RecallPkmn1[] = _("{B_TRAINER1_NAME}: {B_OPPONENT_MON1_NAME}, come\nback!");
static const u8 sText_Trainer1WinText[] = _("{B_TRAINER1_WIN_TEXT}");
static const u8 sText_Trainer1RecallPkmn2[] = _("{B_TRAINER1_NAME}: {B_OPPONENT_MON2_NAME}, come\nback!");
...
static const u8 sText_PlayerPanicked[] = _("You panicked and dropped\n¥{B_BUFF1}…\pBack to the lab!{PAUSE_UNTIL_PRESS}");
static const u8 sText_PlayerWhiteoutAgainstTrainer[] = _("You have no more Pokémon that can\nfight!{PAUSE_UNTIL_PRESS}");
...
const u8 gBattleText_MistShroud[] = _("{B_ATK_PREFIX2} team became shrouded in\nmist!");
...
static const u8 sText_PkmnsXBlocksY2[] = _("{B_EFF_NAME_WITH_PREFIX}'s {B_SCR_ACTIVE_ABILITY}\nblocks {B_CURRENT_MOVE}!");
