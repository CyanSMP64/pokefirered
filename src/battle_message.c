...
#define BATTLE_MSG_PROMPT_CHAR_WIDTH 12
...
EWRAM_DATA u16 sBattlerAbilities[MAX_BATTLERS_COUNT] = {};
...
static const u8 sText_Trainer1RecallPkmn1[] = _("{B_TRAINER1_NAME}{ENG}: {B_OPPONENT_MON1_NAME}, come back!");
static const u8 sText_Trainer1WinText[] = _("{B_TRAINER1_WIN_TEXT}");
static const u8 sText_Trainer1RecallPkmn2[] = _("{B_TRAINER1_NAME}{ENG}: {B_OPPONENT_MON2_NAME}, come back!");
static const u8 sText_Trainer1RecallBoth[] = _("{B_TRAINER1_NAME}{ENG}: {B_OPPONENT_MON1_NAME} and {B_OPPONENT_MON2_NAME}, come back!");
...
static const u8 sText_PlayerPanicked[] = _("You panicked and dropped ¥{B_BUFF1}…\pBack to the lab!{PAUSE_UNTIL_PRESS}");
static const u8 sText_PlayerWhiteoutAgainstTrainer[] = _("You have no more Pokémon that can fight!{PAUSE_UNTIL_PRESS}");
static const u8 sText_PlayerPaidAsPrizeMoney[] = _("You gave ¥{B_BUFF1} to the winner…\pBack to the lab!{PAUSE_UNTIL_PRESS}");
...
const u8 gBattleText_MistShroud[] = _("{B_ATK_PREFIX2} team became shrouded in mist!");
static const u8 sText_PkmnProtectedByMist[] = _("{B_SCR_ACTIVE_NAME_WITH_PREFIX} is protected by the mist!");
const u8 gBattleText_GetPumped[] = _("{B_ATK_NAME_WITH_PREFIX} is getting pumped!");
...
static const u8 sText_PkmnPickedUpItem[] = _("{B_PLAYER_NAME} picked up ¥{B_BUFF1}!\p");
...
static const u8 sText_PkmnUsedXToGetPumped[] = _("{B_SCR_ACTIVE_NAME_WITH_PREFIX} used {B_LAST_ITEM} to hustle!");
...
static const u8 sText_PkmnsXBlocksY2[] = _("{B_EFF_NAME_WITH_PREFIX}'s {B_SCR_ACTIVE_ABILITY} blocks {B_CURRENT_MOVE}!");
...
static const u8 sText_CriticalHit[] = _("{COLOR DARK_GRAY}A critical hit!");
...
static const u8 sText_WildPkmnAppeared2[] = _("{B_OPPONENT_MON1_NAME} appeared!\p");
...
static const u8 sText_GhostAppearedCantId[] = _("The Ghost appeared!\pDarn! The Ghost can't be identified!\p");
static const u8 sText_TheGhostAppeared[] = _("The Ghost appeared!\p");
static const u8 sText_SilphScopeUnveil[] = _("Silph Scope unveiled the Ghost's identity!");
...
const u8 sText_PkmnGoodComeBack[] = _("{B_BUFF1}, good! Come back!");
...
static const u8 sText_OldManUsedItem[] = _("The old man used {B_A_AN_ITEM_GRAMMAR} {B_LAST_ITEM}!");
static const u8 sText_PokedudeUsedItem[] = _("The Poké Dude used {B_A_AN_ITEM_GRAMMAR} {B_LAST_ITEM}!");
...
static const u8 sText_ItDodgedBall2[] = _("よけられた! こいつは つかまりそうにないぞ!"); // Unused version of the Marowak ghost dodging text
static const u8 sText_GotchaPkmnCaught[] = _("Gotcha! {B_OPPONENT_MON1_NAME} was caught!{WAIT_SE}{PLAY_BGM MUS_RG_CAUGHT}\p");
static const u8 sText_GotchaPkmnCaught2[] = _("Gotcha! {B_OPPONENT_MON1_NAME} was caught!{WAIT_SE}{PLAY_BGM MUS_RG_CAUGHT}{PAUSE 127}");
...
static const u8 sText_PlayedFluteCatchyTune[] = _("You played the {B_LAST_ITEM}.\pNow, that's a catchy tune!");
static const u8 sText_PlayedThe[] = _("You played the {B_LAST_ITEM}.");
...
const u8 gText_ForPetesSake[] = _("Oak: Oh, for Pete's sake… So pushy, as always.\p{B_PLAYER_NAME}.\pYou've never had a Pokémon battle before, have you?\pA Pokémon battle is when Trainers pit their Pokémon against each other.\p");
...
const u8 gText_TryBattling[] = _("But rather than talking about it, you'll learn more from experience.\pTry battling and see for yourself.\p");
...
const u8 gText_KeepAnEyeOnHP[] = _("Oak: Keep your eyes on your Pokémon's HP.\pIt will faint if the HP drops to “0.”\p");
const u8 gText_OakNoRunningFromATrainer[] = _("Oak: No! There's no running away from a Trainer Pokémon battle!\p");
const u8 gText_WinEarnsPrizeMoney[] = _("Oak: You got out! Nice!\p");
const u8 gText_HowDissapointing[] = _("Oak: Back to the lab!\p");
...
{
    [B_MSG_ABILITY_PREVENTS_MOVE_STATUS]    = STRINGID_ITDOESNTAFFECT,
...
void BufferStringBattle(u16 stringId)
{
    ...
    *(&gBattleStruct->stringMoveType) = sBattleMsgDataPtr->moveType;
    ...
    case STRINGID_USEDMOVE: // pokemon used a move msg
        ...
        if (sBattleMsgDataPtr->originallyUsedMove == MOVE_METRONOME
         && sBattleMsgDataPtr->currentMove != MOVE_METRONOME)
            stringPtr = sText_MetronomeUsedX;
        else if (sBattleMsgDataPtr->originallyUsedMove == MOVE_NATURE_POWER
         && sBattleMsgDataPtr->currentMove != MOVE_NATURE_POWER)
