...
const u8 *const gItemEffectTable[] =
{
    ...
    [ITEM_KINGS_ROCK - ITEM_POTION]    = sItemEffect_LeafStone,
    [ITEM_METAL_COAT - ITEM_POTION]    = sItemEffect_LeafStone,
    [ITEM_DEEP_SEA_SCALE - ITEM_POTION] = sItemEffect_LeafStone,
    [ITEM_DEEP_SEA_TOOTH - ITEM_POTION] = sItemEffect_LeafStone,
    ...
    [ITEM_RAZOR_CLAW - ITEM_POTION]    = sItemEffect_LeafStone,
    [ITEM_RAZOR_FANG - ITEM_POTION]    = sItemEffect_LeafStone,
    [ITEM_LINKING_CORD - ITEM_POTION]  = sItemEffect_LeafStone,
