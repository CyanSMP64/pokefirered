const struct Evolution gEvolutionTable[NUM_SPECIES][EVOS_PER_MON] =
{
    ...
    [SPECIES_PIKACHU]               = {{EVO_ITEM, ITEM_THUNDER_STONE, SPECIES_RAICHU},
                                       {EVO_ITEM_CASCOON, ITEM_THUNDER_STONE, SPECIES_RAICHU_ALOLAN}},
    ...
    [SPECIES_EXEGGCUTE]             = {{EVO_ITEM, ITEM_LEAF_STONE, SPECIES_EXEGGUTOR},
                                       {EVO_ITEM_CASCOON, ITEM_LEAF_STONE, SPECIES_EXEGGUTOR_ALOLAN}},
    [SPECIES_CUBONE]                = {{EVO_LEVEL, 28, SPECIES_MAROWAK},
                                       {EVO_LEVEL_CASCOON, 28, SPECIES_MAROWAK_ALOLAN}},
    ...
    [SPECIES_MIME_JR]               = {{EVO_LEVEL, 15, SPECIES_MR_MIME},
                                       {EVO_LEVEL_CASCOON, 15, SPECIES_MR_MIME_GALARIAN}},
    ...
    [SPECIES_DOUBLADE]              = {{EVO_ITEM, ITEM_DUSK_STONE, SPECIES_AEGISLASH},
                                       {EVO_ITEM_CASCOON, ITEM_DUSK_STONE, SPECIES_AEGISLASH_BLADE}},
