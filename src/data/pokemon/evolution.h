const struct Evolution gEvolutionTable[NUM_SPECIES][EVOS_PER_MON] =
{
    ...
    [SPECIES_PIKACHU]               = {{EVO_ITEM, ITEM_THUNDER_STONE, SPECIES_RAICHU},
                                       {EVO_ITEM_REG_ROCK, ITEM_THUNDER_STONE, SPECIES_RAICHU_ALOLAN}},
    ...
    [SPECIES_EXEGGCUTE]             = {{EVO_ITEM, ITEM_LEAF_STONE, SPECIES_EXEGGUTOR},
                                       {EVO_ITEM_REG_ROCK, ITEM_LEAF_STONE, SPECIES_EXEGGUTOR_ALOLAN}},
    [SPECIES_CUBONE]                = {{EVO_LEVEL, 28, SPECIES_MAROWAK},
                                       {EVO_LEVEL_REG_ROCK, 28, SPECIES_MAROWAK_ALOLAN}},
    [SPECIES_LICKITUNG]             = {{EVO_LEVEL, 33, SPECIES_LICKILICKY}},
    [SPECIES_KOFFING]               = {{EVO_LEVEL, 35, SPECIES_WEEZING},
                                       {EVO_LEVEL_REG_ROCK, 35, SPECIES_WEEZING_GALARIAN}},
    ...
    [SPECIES_QUILAVA]               = {{EVO_LEVEL, 36, SPECIES_TYPHLOSION},
                                       {EVO_LEVEL_REG_ROCK, 36, SPECIES_TYPHLOSION_HISUIAN}},
    ...
    [SPECIES_MIME_JR]               = {{EVO_LEVEL, 15, SPECIES_MR_MIME},
                                       {EVO_LEVEL_REG_ROCK, 15, SPECIES_MR_MIME_GALARIAN}},
    ...
    [SPECIES_DEWOTT]                = {{EVO_LEVEL, 36, SPECIES_SAMUROTT},
                                       {EVO_LEVEL_REG_ROCK, 36, SPECIES_SAMUROTT_HISUIAN}},
    ...
    [SPECIES_PETILIL]               = {{EVO_ITEM, ITEM_SUN_STONE, SPECIES_LILLIGANT},
                                       {EVO_ITEM_REG_ROCK, ITEM_SUN_STONE, SPECIES_LILLIGANT_HISUIAN}},
    ...
    [SPECIES_RUFFLET]               = {{EVO_LEVEL, 54, SPECIES_BRAVIARY},
                                       {EVO_LEVEL_REG_ROCK, 54, SPECIES_BRAVIARY_HISUIAN}},
    ...
    [SPECIES_GOOMY]                 = {{EVO_LEVEL, 40, SPECIES_SLIGGOO},
                                       {EVO_LEVEL_REG_ROCK, 40, SPECIES_SLIGGOO_HISUIAN}},
    ...
    [SPECIES_BERGMITE]              = {{EVO_LEVEL, 37, SPECIES_AVALUGG},
                                       {EVO_LEVEL_REG_ROCK, 37, SPECIES_AVALUGG_HISUIAN}},
    ...
    [SPECIES_DARTRIX]               = {{EVO_LEVEL, 34, SPECIES_DECIDUEYE},
                                       {EVO_LEVEL_REG_ROCK, 34, SPECIES_DECIDUEYE_HISUIAN}},
    ...
    [SPECIES_ROCKRUFF]              = {{EVO_ITEM, ITEM_MOON_STONE, SPECIES_LYCANROC_MIDNIGHT},
                                       {EVO_ITEM, ITEM_SUN_STONE, SPECIES_LYCANROC},
    ...
    [SPECIES_TOXEL]                 = {{EVO_LEVEL, 30, SPECIES_TOXTRICITY},
                                       {EVO_LEVEL_LOW_KEY, 30, SPECIES_TOXTRICITY_LOW_KEY}},
