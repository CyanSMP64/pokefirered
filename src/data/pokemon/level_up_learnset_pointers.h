const u32 *const gLevelUpLearnsets[NUM_SPECIES] =
{
    ...
    [SPECIES_MANAPHY_EGG] = sSpecies252LevelUpLearnset,
    [SPECIES_CHALKBOARD_1] = sSpecies253LevelUpLearnset,
    [SPECIES_CHALKBOARD_2] = sSpecies254LevelUpLearnset,
    [SPECIES_CHALKBOARD_3] = sSpecies255LevelUpLearnset,
    ...
    [SPECIES_PIKACHU_CAP] = sPikachuCapLevelUpLearnset,
    ...
    [SPECIES_PICHU_SPIKY_EARED] = sPichuSpikyLevelUpLearnset,
    ...
    [SPECIES_BURMY_SANDY_CLOAK] = sBurmySandyCloakLevelUpLearnset,
    [SPECIES_BURMY_TRASH_CLOAK] = sBurmyTrashCloakLevelUpLearnset,
    ...
    [SPECIES_CHERRIM_SUNSHINE] = sCherrimSunshineLevelUpLearnset,
    ...
    [SPECIES_AEGISLASH_BLADE] = sAegislashBladeLevelUpLearnset,
    [SPECIES_PUMPKABOO_SMALL] = sPumpkabooSmallLevelUpLearnset,
    [SPECIES_PUMPKABOO_LARGE] = sPumpkabooLargeLevelUpLearnset,
    [SPECIES_PUMPKABOO_SUPER] = sPumpkabooSuperLevelUpLearnset,
    [SPECIES_GOURGEIST_SMALL] = sGourgeistSmallLevelUpLearnset,
    [SPECIES_GOURGEIST_LARGE] = sGourgeistLargeLevelUpLearnset,
    [SPECIES_GOURGEIST_SUPER] = sGourgeistSuperLevelUpLearnset,
    ...
    [SPECIES_INDEEDEE_FEMALE] = sIndeedeeFLevelUpLearnset,
    [SPECIES_MORPEKO_HANGRY] = sMorpekoHangryLevelUpLearnset,
    ...
    [SPECIES_ETERNATUS_ETERNAMAX] = sEternatusEternamaxLevelUpLearnset,
    ...
    [SPECIES_SCRAFTY_MEGA] = sScraftyMegaLevelUpLearnset,
    [SPECIES_EELEKTROSS_MEGA] = sEelektrossMegaLevelUpLearnset,
    [SPECIES_CHANDELURE_MEGA] = sChandelureMegaLevelUpLearnset,
    [SPECIES_CHESNAUGHT_MEGA] = sChesnaughtMegaLevelUpLearnset,
    [SPECIES_DELPHOX_MEGA] = sDelphoxMegaLevelUpLearnset,
    [SPECIES_GRENINJA_MEGA] = sGreninjaMegaLevelUpLearnset,
    [SPECIES_PYROAR_MEGA] = sPyroarMegaLevelUpLearnset,
    [SPECIES_FLOETTE_MEGA] = sFloetteMegaLevelUpLearnset,
    ...
    [SPECIES_ZYGARDE_MEGA] = sZygardeMegaLevelUpLearnset,
    [SPECIES_DRAMPA_MEGA] = sDrampaMegaLevelUpLearnset,
    [SPECIES_FALINKS_MEGA] = sFalinksMegaLevelUpLearnset,
    [SPECIES_RAICHU_MEGA_X] = sRaichuMegaXLevelUpLearnset,
    [SPECIES_RAICHU_MEGA_Y] = sRaichuMegaYLevelUpLearnset,
    [SPECIES_CHIMECHO_MEGA] = sChimechoMegaLevelUpLearnset,
    [SPECIES_ABSOL_MEGA_Z] = sAbsolMegaZLevelUpLearnset,
    [SPECIES_STARAPTOR_MEGA] = sStaraptorMegaLevelUpLearnset,
    [SPECIES_GARCHOMP_MEGA_Z] = sGarchompMegaZLevelUpLearnset,
    [SPECIES_LUCARIO_MEGA_Z] = sLucarioMegaZLevelUpLearnset,
    [SPECIES_HEATRAN_MEGA] = sHeatranMegaLevelUpLearnset,
    [SPECIES_DARKRAI_MEGA] = sDarkraiMegaLevelUpLearnset,
    ...
    [SPECIES_MAGEARNA_MEGA] = sMagearnaMegaLevelUpLearnset,
    [SPECIES_ZERAORA_MEGA] = sZeraoraMegaLevelUpLearnset,
    ...
    [SPECIES_MEOWSTIC_FEMALE_MEGA] = sMeowsticFemaleMegaLevelUpLearnset,
};
