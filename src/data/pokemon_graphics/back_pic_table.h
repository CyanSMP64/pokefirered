const struct CompressedSpriteSheet gMonBackPicTable[] =
{
    ...
    SPECIES_SPRITE(VENUSAUR_FEMALE, gMonBackPic_Venusaur),
    SPECIES_SPRITE(BUTTERFREE_FEMALE, gMonBackPic_Butterfree),
    SPECIES_SPRITE(RATTATA_FEMALE, gMonBackPic_Rattata),
    SPECIES_SPRITE(RATICATE_FEMALE, gMonBackPic_Raticate),
    SPECIES_SPRITE(PIKACHU_FEMALE, gMonBackPic_Pikachu),
    SPECIES_SPRITE(RAICHU_FEMALE, gMonBackPic_Raichu),
    SPECIES_SPRITE(ZUBAT_FEMALE, gMonBackPic_Zubat),
    SPECIES_SPRITE(GOLBAT_FEMALE, gMonBackPic_Golbat),
    SPECIES_SPRITE(GLOOM_FEMALE, gMonBackPic_Gloom),
    SPECIES_SPRITE(VILEPLUME_FEMALE, gMonBackPic_Vileplume),
    SPECIES_SPRITE(KADABRA_FEMALE, gMonBackPic_Kadabra),
    SPECIES_SPRITE(ALAKAZAM_FEMALE, gMonBackPic_Alakazam),
    SPECIES_SPRITE(DODUO_FEMALE, gMonBackPic_Doduo),
    SPECIES_SPRITE(DODRIO_FEMALE, gMonBackPic_Dodrio),
    SPECIES_SPRITE(HYPNO_FEMALE, gMonBackPic_Hypno),
    SPECIES_SPRITE(RHYHORN_FEMALE, gMonBackPic_Rhyhorn),
    SPECIES_SPRITE(RHYDON_FEMALE, gMonBackPic_Rhydon),
    SPECIES_SPRITE(GOLDEEN_FEMALE, gMonBackPic_Goldeen),
    SPECIES_SPRITE(SEAKING_FEMALE, gMonBackPic_Seaking),
    SPECIES_SPRITE(SCYTHER_FEMALE, gMonBackPic_Scyther),
    SPECIES_SPRITE(MAGIKARP_FEMALE, gMonBackPic_Magikarp),
    SPECIES_SPRITE(GYARADOS_FEMALE, gMonBackPic_Gyarados),
    SPECIES_SPRITE(EEVEE_FEMALE, gMonBackPic_Eevee),
    SPECIES_SPRITE(MEGANIUM_FEMALE, gMonBackPic_Meganium),
    SPECIES_SPRITE(LEDYBA_FEMALE, gMonBackPic_Ledyba),
    SPECIES_SPRITE(LEDIAN_FEMALE, gMonBackPic_Ledian),
    SPECIES_SPRITE(XATU_FEMALE, gMonBackPic_Xatu),
    SPECIES_SPRITE(SUDOWOODO_FEMALE, gMonBackPic_Sudowoodo),
    SPECIES_SPRITE(POLITOED_FEMALE, gMonBackPic_Politoed),
    SPECIES_SPRITE(AIPOM_FEMALE, gMonBackPic_Aipom),
    SPECIES_SPRITE(WOOPER_FEMALE, gMonBackPic_Wooper),
    SPECIES_SPRITE(QUAGSIRE_FEMALE, gMonBackPic_Quagsire),
    SPECIES_SPRITE(MURKROW_FEMALE, gMonBackPic_Murkrow),
    SPECIES_SPRITE(WOBBUFFET_FEMALE, gMonBackPic_Wobbuffet),
    SPECIES_SPRITE(GIRAFARIG_FEMALE, gMonBackPic_Girafarig),
    SPECIES_SPRITE(GLIGAR_FEMALE, gMonBackPic_Gligar),
    SPECIES_SPRITE(STEELIX_FEMALE, gMonBackPic_Steelix),
    SPECIES_SPRITE(SCIZOR_FEMALE, gMonBackPic_Scizor),
    SPECIES_SPRITE(HERACROSS_FEMALE, gMonBackPic_Heracross),
    SPECIES_SPRITE(SNEASEL_FEMALE, gMonBackPic_Sneasel),
    SPECIES_SPRITE(URSARING_FEMALE, gMonBackPic_Ursaring),
    SPECIES_SPRITE(PILOSWINE_FEMALE, gMonBackPic_Piloswine),
    SPECIES_SPRITE(OCTILLERY_FEMALE, gMonBackPic_Octillery),
    SPECIES_SPRITE(HOUNDOOM_FEMALE, gMonBackPic_Houndoom),
    SPECIES_SPRITE(DONPHAN_FEMALE, gMonBackPic_Donphan),
    SPECIES_SPRITE(TORCHIC_FEMALE, gMonBackPic_Torchic),
    SPECIES_SPRITE(COMBUSKEN_FEMALE, gMonBackPic_Combusken),
    SPECIES_SPRITE(BLAZIKEN_FEMALE, gMonBackPic_Blaziken),
    SPECIES_SPRITE(BEAUTIFLY_FEMALE, gMonBackPic_Beautifly),
    SPECIES_SPRITE(DUSTOX_FEMALE, gMonBackPic_Dustox),
    SPECIES_SPRITE(LUDICOLO_FEMALE, gMonBackPic_Ludicolo),
    SPECIES_SPRITE(NUZLEAF_FEMALE, gMonBackPic_Nuzleaf),
    SPECIES_SPRITE(SHIFTRY_FEMALE, gMonBackPic_Shiftry),
    SPECIES_SPRITE(MEDITITE_FEMALE, gMonBackPic_Meditite),
    SPECIES_SPRITE(MEDICHAM_FEMALE, gMonBackPic_Medicham),
    SPECIES_SPRITE(ROSELIA_FEMALE, gMonBackPic_Roselia),
    SPECIES_SPRITE(GULPIN_FEMALE, gMonBackPic_Gulpin),
    SPECIES_SPRITE(SWALOT_FEMALE, gMonBackPic_Swalot),
    SPECIES_SPRITE(NUMEL_FEMALE, gMonBackPic_Numel),
    SPECIES_SPRITE(CAMERUPT_FEMALE, gMonBackPic_Camerupt),
    SPECIES_SPRITE(CACTURNE_FEMALE, gMonBackPic_Cacturne),
    SPECIES_SPRITE(MILOTIC_FEMALE, gMonBackPic_Milotic),
    SPECIES_SPRITE(RELICANTH_FEMALE, gMonBackPic_Relicanth),
    SPECIES_SPRITE(STARLY_FEMALE, gMonBackPic_Starly),
    SPECIES_SPRITE(STARAVIA_FEMALE, gMonBackPic_Staravia),
    SPECIES_SPRITE(STARAPTOR_FEMALE, gMonBackPic_Staraptor),
    SPECIES_SPRITE(BIDOOF_FEMALE, gMonBackPic_Bidoof),
    SPECIES_SPRITE(BIBAREL_FEMALE, gMonBackPic_Bibarel),
    SPECIES_SPRITE(KRICKETOT_FEMALE, gMonBackPic_Kricketot),
    SPECIES_SPRITE(KRICKETUNE_FEMALE, gMonBackPic_Kricketune),
    SPECIES_SPRITE(SHINX_FEMALE, gMonBackPic_Shinx),
    SPECIES_SPRITE(LUXIO_FEMALE, gMonBackPic_Luxio),
    SPECIES_SPRITE(LUXRAY_FEMALE, gMonBackPic_Luxray),
    SPECIES_SPRITE(ROSERADE_FEMALE, gMonBackPic_Roserade),
    SPECIES_SPRITE(BUIZEL_FEMALE, gMonBackPic_Buizel),
    SPECIES_SPRITE(FLOATZEL_FEMALE, gMonBackPic_Floatzel),
    SPECIES_SPRITE(AMBIPOM_FEMALE, gMonBackPic_Ambipom),
    SPECIES_SPRITE(GIBLE_FEMALE, gMonBackPic_Gible),
    SPECIES_SPRITE(GABITE_FEMALE, gMonBackPic_Gabite),
    SPECIES_SPRITE(GARCHOMP_FEMALE, gMonBackPic_Garchomp),
    SPECIES_SPRITE(CROAGUNK_FEMALE, gMonBackPic_Croagunk),
    SPECIES_SPRITE(TOXICROAK_FEMALE, gMonBackPic_Toxicroak),
    SPECIES_SPRITE(FINNEON_FEMALE, gMonBackPic_Finneon),
    SPECIES_SPRITE(LUMINEON_FEMALE, gMonBackPic_Lumineon),
    SPECIES_SPRITE(SNOVER_FEMALE, gMonBackPic_Snover),
    SPECIES_SPRITE(ABOMASNOW_FEMALE, gMonBackPic_Abomasnow),
    SPECIES_SPRITE(WEAVILE_FEMALE, gMonBackPic_Weavile),
    SPECIES_SPRITE(RHYPERIOR_FEMALE, gMonBackPic_Rhyperior),
    SPECIES_SPRITE(TANGROWTH_FEMALE, gMonBackPic_Tangrowth),
    SPECIES_SPRITE(MAMOSWINE_FEMALE, gMonBackPic_Mamoswine),
    SPECIES_SPRITE(SNEASEL_HISUIAN_FEMALE, gMonBackPic_SneaselHisuian),
    SPECIES_SPRITE(PIKACHU_PARTNER_FEMALE, gMonBackPic_PikachuPartner),
    SPECIES_SPRITE(EEVEE_PARTNER_FEMALE, gMonBackPic_EeveePartner),
};
