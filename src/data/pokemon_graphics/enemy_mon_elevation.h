...
const u8 gEnemyMonElevation[NUM_SPECIES] =
{
    ...
    [SPECIES_RAICHU_MEGA_X] = 6,
    [SPECIES_SKARMORY_MEGA] = 6,
    [SPECIES_STARAPTOR_MEGA] = 7,
    [SPECIES_CHANDELURE_MEGA] = 6,
    [SPECIES_DELPHOX_MEGA] = 5,
    [SPECIES_GRENINJA_MEGA] = 8,
    [SPECIES_DRAGALGE_MEGA] = 5,
    [SPECIES_GLIMMORA_MEGA] = 5,
    [SPECIES_DRAMPA_MEGA] = 4,
    [SPECIES_CHIMECHO_MEGA] = 6,
    [SPECIES_EELEKTROSS_MEGA] = 5,
    [SPECIES_ZYGARDE_MEGA] = 7,
    [SPECIES_DARKRAI_MEGA] = 6,
    [SPECIES_MEOWSTIC_MEGA] = 7,
    [SPECIES_MEOWSTIC_FEMALE_MEGA] = 7,
    [SPECIES_FLOETTE_MEGA] = 8,
