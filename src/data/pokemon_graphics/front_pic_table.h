const struct CompressedSpriteSheet gMonFrontPicTable[] =
{
    ...
    SPECIES_SPRITE(VENUSAUR_FEMALE, gMonFrontPic_Venusaur),
    SPECIES_SPRITE(BUTTERFREE_FEMALE, gMonFrontPic_Butterfree),
    SPECIES_SPRITE(RATTATA_FEMALE, gMonFrontPic_Rattata),
    SPECIES_SPRITE(RATICATE_FEMALE, gMonFrontPic_Raticate),
    SPECIES_SPRITE(PIKACHU_FEMALE, gMonFrontPic_Pikachu),
    SPECIES_SPRITE(RAICHU_FEMALE, gMonFrontPic_Raichu),
    SPECIES_SPRITE(ZUBAT_FEMALE, gMonFrontPic_Zubat),
    SPECIES_SPRITE(GOLBAT_FEMALE, gMonFrontPic_Golbat),
    SPECIES_SPRITE(GLOOM_FEMALE, gMonFrontPic_Gloom),
    SPECIES_SPRITE(VILEPLUME_FEMALE, gMonFrontPic_Vileplume),
    SPECIES_SPRITE(KADABRA_FEMALE, gMonFrontPic_Kadabra),
    SPECIES_SPRITE(ALAKAZAM_FEMALE, gMonFrontPic_Alakazam),
    SPECIES_SPRITE(DODUO_FEMALE, gMonFrontPic_Doduo),
    SPECIES_SPRITE(DODRIO_FEMALE, gMonFrontPic_Dodrio),
    SPECIES_SPRITE(HYPNO_FEMALE, gMonFrontPic_Hypno),
    SPECIES_SPRITE(RHYHORN_FEMALE, gMonFrontPic_Rhyhorn),
    SPECIES_SPRITE(RHYDON_FEMALE, gMonFrontPic_Rhydon),
    SPECIES_SPRITE(GOLDEEN_FEMALE, gMonFrontPic_Goldeen),
    SPECIES_SPRITE(SEAKING_FEMALE, gMonFrontPic_Seaking),
    SPECIES_SPRITE(SCYTHER_FEMALE, gMonFrontPic_Scyther),
    SPECIES_SPRITE(MAGIKARP_FEMALE, gMonFrontPic_Magikarp),
    SPECIES_SPRITE(GYARADOS_FEMALE, gMonFrontPic_Gyarados),
    SPECIES_SPRITE(EEVEE_FEMALE, gMonFrontPic_Eevee),
    SPECIES_SPRITE(MEGANIUM_FEMALE, gMonFrontPic_Meganium),
    SPECIES_SPRITE(LEDYBA_FEMALE, gMonFrontPic_Ledyba),
    SPECIES_SPRITE(LEDIAN_FEMALE, gMonFrontPic_Ledian),
    SPECIES_SPRITE(XATU_FEMALE, gMonFrontPic_Xatu),
    SPECIES_SPRITE(SUDOWOODO_FEMALE, gMonFrontPic_Sudowoodo),
    SPECIES_SPRITE(POLITOED_FEMALE, gMonFrontPic_Politoed),
    SPECIES_SPRITE(AIPOM_FEMALE, gMonFrontPic_Aipom),
    SPECIES_SPRITE(WOOPER_FEMALE, gMonFrontPic_Wooper),
    SPECIES_SPRITE(QUAGSIRE_FEMALE, gMonFrontPic_Quagsire),
    SPECIES_SPRITE(MURKROW_FEMALE, gMonFrontPic_Murkrow),
    SPECIES_SPRITE(WOBBUFFET_FEMALE, gMonFrontPic_Wobbuffet),
    SPECIES_SPRITE(GIRAFARIG_FEMALE, gMonFrontPic_Girafarig),
    SPECIES_SPRITE(GLIGAR_FEMALE, gMonFrontPic_Gligar),
    SPECIES_SPRITE(STEELIX_FEMALE, gMonFrontPic_Steelix),
    SPECIES_SPRITE(SCIZOR_FEMALE, gMonFrontPic_Scizor),
    SPECIES_SPRITE(HERACROSS_FEMALE, gMonFrontPic_Heracross),
    SPECIES_SPRITE(SNEASEL_FEMALE, gMonFrontPic_Sneasel),
    SPECIES_SPRITE(URSARING_FEMALE, gMonFrontPic_Ursaring),
    SPECIES_SPRITE(PILOSWINE_FEMALE, gMonFrontPic_Piloswine),
    SPECIES_SPRITE(OCTILLERY_FEMALE, gMonFrontPic_Octillery),
    SPECIES_SPRITE(HOUNDOOM_FEMALE, gMonFrontPic_Houndoom),
    SPECIES_SPRITE(DONPHAN_FEMALE, gMonFrontPic_Donphan),
    SPECIES_SPRITE(TORCHIC_FEMALE, gMonFrontPic_Torchic),
    SPECIES_SPRITE(COMBUSKEN_FEMALE, gMonFrontPic_Combusken),
    SPECIES_SPRITE(BLAZIKEN_FEMALE, gMonFrontPic_Blaziken),
    SPECIES_SPRITE(BEAUTIFLY_FEMALE, gMonFrontPic_Beautifly),
    SPECIES_SPRITE(DUSTOX_FEMALE, gMonFrontPic_Dustox),
    SPECIES_SPRITE(LUDICOLO_FEMALE, gMonFrontPic_Ludicolo),
    SPECIES_SPRITE(NUZLEAF_FEMALE, gMonFrontPic_Nuzleaf),
    SPECIES_SPRITE(SHIFTRY_FEMALE, gMonFrontPic_Shiftry),
    SPECIES_SPRITE(MEDITITE_FEMALE, gMonFrontPic_Meditite),
    SPECIES_SPRITE(MEDICHAM_FEMALE, gMonFrontPic_Medicham),
    SPECIES_SPRITE(ROSELIA_FEMALE, gMonFrontPic_Roselia),
    SPECIES_SPRITE(GULPIN_FEMALE, gMonFrontPic_Gulpin),
    SPECIES_SPRITE(SWALOT_FEMALE, gMonFrontPic_Swalot),
    SPECIES_SPRITE(NUMEL_FEMALE, gMonFrontPic_Numel),
    SPECIES_SPRITE(CAMERUPT_FEMALE, gMonFrontPic_Camerupt),
    SPECIES_SPRITE(CACTURNE_FEMALE, gMonFrontPic_Cacturne),
    SPECIES_SPRITE(MILOTIC_FEMALE, gMonFrontPic_Milotic),
    SPECIES_SPRITE(RELICANTH_FEMALE, gMonFrontPic_Relicanth),
    SPECIES_SPRITE(STARLY_FEMALE, gMonFrontPic_Starly),
    SPECIES_SPRITE(STARAVIA_FEMALE, gMonFrontPic_Staravia),
    SPECIES_SPRITE(STARAPTOR_FEMALE, gMonFrontPic_Staraptor),
    SPECIES_SPRITE(BIDOOF_FEMALE, gMonFrontPic_Bidoof),
    SPECIES_SPRITE(BIBAREL_FEMALE, gMonFrontPic_Bibarel),
    SPECIES_SPRITE(KRICKETOT_FEMALE, gMonFrontPic_Kricketot),
    SPECIES_SPRITE(KRICKETUNE_FEMALE, gMonFrontPic_Kricketune),
    SPECIES_SPRITE(SHINX_FEMALE, gMonFrontPic_Shinx),
    SPECIES_SPRITE(LUXIO_FEMALE, gMonFrontPic_Luxio),
    SPECIES_SPRITE(LUXRAY_FEMALE, gMonFrontPic_Luxray),
    SPECIES_SPRITE(ROSERADE_FEMALE, gMonFrontPic_Roserade),
    SPECIES_SPRITE(BUIZEL_FEMALE, gMonFrontPic_Buizel),
    SPECIES_SPRITE(FLOATZEL_FEMALE, gMonFrontPic_Floatzel),
    SPECIES_SPRITE(AMBIPOM_FEMALE, gMonFrontPic_Ambipom),
    SPECIES_SPRITE(GIBLE_FEMALE, gMonFrontPic_Gible),
    SPECIES_SPRITE(GABITE_FEMALE, gMonFrontPic_Gabite),
    SPECIES_SPRITE(GARCHOMP_FEMALE, gMonFrontPic_Garchomp),
    SPECIES_SPRITE(CROAGUNK_FEMALE, gMonFrontPic_Croagunk),
    SPECIES_SPRITE(TOXICROAK_FEMALE, gMonFrontPic_Toxicroak),
    SPECIES_SPRITE(FINNEON_FEMALE, gMonFrontPic_Finneon),
    SPECIES_SPRITE(LUMINEON_FEMALE, gMonFrontPic_Lumineon),
    SPECIES_SPRITE(SNOVER_FEMALE, gMonFrontPic_Snover),
    SPECIES_SPRITE(ABOMASNOW_FEMALE, gMonFrontPic_Abomasnow),
    SPECIES_SPRITE(WEAVILE_FEMALE, gMonFrontPic_Weavile),
    SPECIES_SPRITE(RHYPERIOR_FEMALE, gMonFrontPic_Rhyperior),
    SPECIES_SPRITE(TANGROWTH_FEMALE, gMonFrontPic_Tangrowth),
    SPECIES_SPRITE(MAMOSWINE_FEMALE, gMonFrontPic_Mamoswine),
    SPECIES_SPRITE(SNEASEL_HISUIAN_FEMALE, gMonFrontPic_SneaselHisuian),
    SPECIES_SPRITE(PIKACHU_PARTNER_FEMALE, gMonFrontPic_PikachuPartner),
    SPECIES_SPRITE(EEVEE_PARTNER_FEMALE, gMonFrontPic_EeveePartner),
};
