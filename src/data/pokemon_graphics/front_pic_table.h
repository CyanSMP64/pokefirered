const struct CompressedSpriteSheet gMonFrontPicTable[] =
{
    ...
    SPECIES_SPRITE(MANAPHY_EGG, gMonFrontPic_EggManaphy),
    SPECIES_SPRITE(CHALKBOARD_1, gMonFrontPic_Chalkboard1),
    SPECIES_SPRITE(CHALKBOARD_2, gMonFrontPic_Chalkboard2),
    SPECIES_SPRITE(CHALKBOARD_3, gMonFrontPic_Chalkboard3),
