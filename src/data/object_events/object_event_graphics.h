...
const u16 gObjectEventPic_Cyan[] = INCBIN_U16("graphics/object_events/pics/people/cyan.4bpp");
const u16 gObjectEventPic_Stereo[] = INCBIN_U16("graphics/object_events/pics/misc/stereo.4bpp");
const u16 gObjectEventPic_CyndaquilDoll[] = INCBIN_U16("graphics/object_events/pics/misc/cyndaquil_doll.4bpp");
const u16 gObjectEventPic_SubstituteDoll[] = INCBIN_U16("graphics/object_events/pics/misc/substitute_doll.4bpp");
