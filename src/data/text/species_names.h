const u8 gSpeciesNames[][POKEMON_NAME_LENGTH + 1] = {
    ...
    // Megas
    [SPECIES_VENUSAUR_MEGA] = _("Venusaur-M"),
    [SPECIES_CHARIZARD_MEGA_X] = _("Charizard-X"),
    [SPECIES_CHARIZARD_MEGA_Y] = _("Charizard-Y"),
    [SPECIES_BLASTOISE_MEGA] = _("Blastoise-M"),
    [SPECIES_BEEDRILL_MEGA] = _("Beedrill-M"),
    [SPECIES_PIDGEOT_MEGA] = _("Pidgeot-M"),
    [SPECIES_ALAKAZAM_MEGA] = _("Alakazam-M"),
    [SPECIES_SLOWBRO_MEGA] = _("Slowbro-M"),
    [SPECIES_GENGAR_MEGA] = _("Gengar-M"),
    [SPECIES_KANGASKHAN_MEGA] = _("Kangaskhan-M"),
    [SPECIES_PINSIR_MEGA] = _("Pinsir-M"),
    [SPECIES_GYARADOS_MEGA] = _("Gyarados-M"),
    [SPECIES_AERODACTYL_MEGA] = _("Aerodactyl-M"),
    [SPECIES_MEWTWO_MEGA_X] = _("Mewtwo-X"),
    [SPECIES_MEWTWO_MEGA_Y] = _("Mewtwo-Y"),
    [SPECIES_AMPHAROS_MEGA] = _("Ampharos-M"),
    [SPECIES_STEELIX_MEGA] = _("Steelix-M"),
    [SPECIES_SCIZOR_MEGA] = _("Scizor-M"),
    [SPECIES_HERACROSS_MEGA] = _("Heracross-M"),
    [SPECIES_HOUNDOOM_MEGA] = _("Houndoom-M"),
    [SPECIES_TYRANITAR_MEGA] = _("Tyranitar-M"),
    [SPECIES_SCEPTILE_MEGA] = _("Sceptile-M"),
    [SPECIES_BLAZIKEN_MEGA] = _("Blaziken-M"),
    [SPECIES_SWAMPERT_MEGA] = _("Swampert-M"),
    [SPECIES_GARDEVOIR_MEGA] = _("Gardevoir-M"),
    [SPECIES_SABLEYE_MEGA] = _("Sableye-M"),
    [SPECIES_MAWILE_MEGA] = _("Mawile-M"),
    [SPECIES_AGGRON_MEGA] = _("Aggron-M"),
    [SPECIES_MEDICHAM_MEGA] = _("Medicham-M"),
    [SPECIES_MANECTRIC_MEGA] = _("Manectric-M"),
    [SPECIES_SHARPEDO_MEGA] = _("Sharpedo-M"),
    [SPECIES_CAMERUPT_MEGA] = _("Camerupt-M"),
    [SPECIES_ALTARIA_MEGA] = _("Altaria-M"),
    [SPECIES_BANETTE_MEGA] = _("Banette-M"),
    [SPECIES_ABSOL_MEGA] = _("Absol-M"),
    [SPECIES_GLALIE_MEGA] = _("Glalie-M"),
    [SPECIES_SALAMENCE_MEGA] = _("Salamence-M"),
    [SPECIES_METAGROSS_MEGA] = _("Metagross-M"),
    [SPECIES_LATIAS_MEGA] = _("Latias-M"),
    [SPECIES_LATIOS_MEGA] = _("Latios-M"),
    [SPECIES_LOPUNNY_MEGA] = _("Lopunny-M"),
    [SPECIES_GARCHOMP_MEGA] = _("Garchomp-M"),
    [SPECIES_LUCARIO_MEGA] = _("Lucario-M"),
    [SPECIES_ABOMASNOW_MEGA] = _("Abomasnow-M"),
    [SPECIES_GALLADE_MEGA] = _("Gallade-M"),
    [SPECIES_AUDINO_MEGA] = _("Audino-M"),
    [SPECIES_DIANCIE_MEGA] = _("Diancie-M"),
    // Special Mega + Primals
    [SPECIES_RAYQUAZA_MEGA] = _("Rayquaza-M"),
    [SPECIES_KYOGRE_PRIMAL] = _("Kyogre-P"),
    [SPECIES_GROUDON_PRIMAL] = _("Groudon-P"),

    // Alolan Forms
    [SPECIES_RATTATA_ALOLAN] = _("Rattata-A"),
    [SPECIES_RATICATE_ALOLAN] = _("Raticate-A"),
    [SPECIES_RAICHU_ALOLAN] = _("Raichu-A"),
    [SPECIES_SANDSHREW_ALOLAN] = _("Sandshrew-A"),
    [SPECIES_SANDSLASH_ALOLAN] = _("Sandslash-A"),
    [SPECIES_VULPIX_ALOLAN] = _("Vulpix-A"),
    [SPECIES_NINETALES_ALOLAN] = _("Ninetales-A"),
    ...
    [SPECIES_EXEGGUTOR_ALOLAN] = _("Exeggutor-A"),
    [SPECIES_MAROWAK_ALOLAN] = _("Marowak-A"),

    // Galarian Forms
    [SPECIES_MEOWTH_GALARIAN] = _("Meowth-G"),
    [SPECIES_PONYTA_GALARIAN] = _("Ponyta-G"),
    [SPECIES_RAPIDASH_GALARIAN] = _("Rapidash-G"),
    [SPECIES_SLOWPOKE_GALARIAN] = _("Slowpoke-G"),
    [SPECIES_SLOWBRO_GALARIAN] = _("Slowbro-G"),
    [SPECIES_FARFETCHD_GALARIAN] = _("Farfetch'd-G"),
    [SPECIES_WEEZING_GALARIAN] = _("Weezing-G"),
    ...
    [SPECIES_ZIGZAGOON_GALARIAN] = _("Zigzagoon-G"),
    [SPECIES_LINOONE_GALARIAN] = _("Linoone-G"),
    [SPECIES_DARUMAKA_GALARIAN] = _("Darumaka-G"),
    [SPECIES_DARMANITAN_GALARIAN] = _("Darmanitan-G"),
    [SPECIES_YAMASK_GALARIAN] = _("Yamask-G"),
    [SPECIES_STUNFISK_GALARIAN] = _("Stunfisk-G"),

//Hisuian Forms
    [SPECIES_GROWLITHE_HISUIAN] = _("Growlithe-H"),
    [SPECIES_ARCANINE_HISUIAN] = _("Arcanine-H"),
    [SPECIES_VOLTORB_HISUIAN] = _("Voltorb-H"),
    [SPECIES_ELECTRODE_HISUIAN] = _("Electrode-H"),
    [SPECIES_TYPHLOSION_HISUIAN] = _("Typhlosion-H"),
    [SPECIES_QWILFISH_HISUIAN] = _("Qwilfish-H"),
    [SPECIES_SNEASEL_HISUIAN] = _("Sneasel-H"),
    [SPECIES_SAMUROTT_HISUIAN] = _("Samurott-H"),
    [SPECIES_LILLIGANT_HISUIAN] = _("Lilligant-H"),
    [SPECIES_ZORUA_HISUIAN] = _("Zorua-H"),
    [SPECIES_ZOROARK_HISUIAN] = _("Zoroark-H"),
    [SPECIES_BRAVIARY_HISUIAN] = _("Braviary-H"),
    [SPECIES_SLIGGOO_HISUIAN] = _("Sliggoo-H"),
    [SPECIES_GOODRA_HISUIAN] = _("Goodra-H"),
    [SPECIES_AVALUGG_HISUIAN] = _("Avalugg-H"),
    [SPECIES_DECIDUEYE_HISUIAN] = _("Decidueye-H"),
    [SPECIES_TAUROS_PALDEAN] = _("Tauros-P"),
    [SPECIES_WOOPER_PALDEAN] = _("Wooper-P"),
    // Pikachu
    [SPECIES_PIKACHU_CAP] = _("Pikachu-C"),
    [SPECIES_PIKACHU_PARTNER] = _("Pikachu-P"),
    // Tauros-Paldea
    [SPECIES_TAUROS_PALDEAN_BLAZE_BREED] = _("Tauros-PF"),
    [SPECIES_TAUROS_PALDEAN_AQUA_BREED] = _("Tauros-PW"),
    // Eevee
    [SPECIES_EEVEE_PARTNER] = _("Eevee-P"),
    // Pichu
    [SPECIES_PICHU_SPIKY_EARED] = _("Pichu-S"),
    // Castform
    [SPECIES_CASTFORM_SUNNY] = _("Castform-F"),
    [SPECIES_CASTFORM_RAINY] = _("Castform-W"),
    [SPECIES_CASTFORM_SNOWY] = _("Castform-I"),
    // Deoxys
    [SPECIES_DEOXYS_ATTACK] = _("Deoxys-A"),
    [SPECIES_DEOXYS_DEFENSE] = _("Deoxys-D"),
    [SPECIES_DEOXYS_SPEED] = _("Deoxys-S"),
    // Burmy
    [SPECIES_BURMY_SANDY_CLOAK] = _("Burmy-S"),
    [SPECIES_BURMY_TRASH_CLOAK] = _("Burmy-T"),
    // Wormadam
    [SPECIES_WORMADAM_SANDY_CLOAK] = _("Wormadam-S"),
    [SPECIES_WORMADAM_TRASH_CLOAK] = _("Wormadam-T"),
    // Cherrim
    [SPECIES_CHERRIM_SUNSHINE] = _("Cherrim-S"),
    // Rotom
    ...
    // Origin Forme
    [SPECIES_DIALGA_ORIGIN] = _("Dialga-O"),
    [SPECIES_PALKIA_ORIGIN] = _("Palkia-O"),
    [SPECIES_GIRATINA_ORIGIN] = _("Giratina-O"),
    // Shaymin
    [SPECIES_SHAYMIN_SKY] = _("Shaymin-S"),
    // Basculin
    [SPECIES_BASCULIN_BLUE_STRIPED] = _("Basculin-B"),
    [SPECIES_BASCULIN_WHITE_STRIPED] = _("Basculin-W"),
    // Darmanitan
    [SPECIES_DARMANITAN_ZEN_MODE] = _("Darmanitan-Z"),
    [SPECIES_DARMANITAN_ZEN_MODE_GALARIAN] = _("DarmanitanGZ"),
    // Therian Forms
    [SPECIES_TORNADUS_THERIAN] = _("Tornadus-T"),
    [SPECIES_THUNDURUS_THERIAN] = _("Thundurus-T"),
    [SPECIES_LANDORUS_THERIAN] = _("Landorus-T"),
    [SPECIES_ENAMORUS_THERIAN] = _("Enamorus-T"),
    // Kyurem
    ...
    [SPECIES_AEGISLASH_BLADE] = _("Aegislash-B"),
    [SPECIES_PUMPKABOO_SMALL] = _("Pumpkaboo-S"),
    [SPECIES_PUMPKABOO_LARGE] = _("Pumpkaboo-L"),
    [SPECIES_PUMPKABOO_SUPER] = _("Pumpkaboo-XL"),
    [SPECIES_GOURGEIST_SMALL] = _("Gourgeist-S"),
    [SPECIES_GOURGEIST_LARGE] = _("Gourgeist-L"),
    [SPECIES_GOURGEIST_SUPER] = _("Gourgeist-XL"),
    // Zygarde
    [SPECIES_ZYGARDE_10] = _("Zygarde-10"),
    [SPECIES_ZYGARDE_COMPLETE] = _("Zygarde-C"),
    // Hoopa
    [SPECIES_HOOPA_UNBOUND] = _("Hoopa-U"),
    // Oricorio
    [SPECIES_ORICORIO_POM_POM] = _("Oricorio-E"),
    [SPECIES_ORICORIO_PAU] = _("Oricorio-P"),
    [SPECIES_ORICORIO_SENSU] = _("Oricorio-G"),
    [SPECIES_LYCANROC_MIDNIGHT] = _("Lycanroc-M"),
    [SPECIES_LYCANROC_DUSK] = _("Lycanroc-D"),
    // Wishiwashi
    [SPECIES_WISHIWASHI_SCHOOL] = _("Wishiwashi-S"),
    [SPECIES_MINIOR_CORE_RED] = _("Minior-C"),
    // Necrozma
    [SPECIES_NECROZMA_DUSK_MANE] = _("Necrozma-DM"),
    [SPECIES_NECROZMA_DAWN_WINGS] = _("Necrozma-DW"),
    [SPECIES_NECROZMA_ULTRA] = _("Necrozma-U"),
    [SPECIES_TOXTRICITY_LOW_KEY] = _("Toxtricity-L"),
    [SPECIES_EISCUE_NOICE_FACE] = _("Eiscue-N"),
    [SPECIES_INDEEDEE_FEMALE] = _("Indeedee-F"),
    [SPECIES_MORPEKO_HANGRY] = _("Morpeko-H"),
    // Zacian
    [SPECIES_ZACIAN_CROWNED_SWORD] = _("Zacian-C"),
    // Zamazenta
    [SPECIES_ZAMAZENTA_CROWNED_SHIELD] = _("Zamazenta-C"),
    // Eternatus
    [SPECIES_ETERNATUS_ETERNAMAX] = _("Eternatus-E"),
    // Urshifu
    [SPECIES_URSHIFU_RAPID_STRIKE_STYLE] = _("Urshifu-R"),
    // Calyrex
    [SPECIES_CALYREX_ICE_RIDER] = _("Calyrex-I"),
    [SPECIES_CALYREX_SHADOW_RIDER] = _("Calyrex-S"),
    [SPECIES_URSALUNA_BLOODMOON] = _("Ursaluna-B"),
    [SPECIES_BASCULEGION_FEMALE] = _("BasculegionF"),
    [SPECIES_OINKOLOGNE_FEMALE] = _("Oinkologne-F"),
    // Palafin
    [SPECIES_PALAFIN_HERO] = _("Palafin-H"),
    [SPECIES_GIMMIGHOUL_ROAMING] = _("Gimmighoul-R"),
    [SPECIES_OGERPON_WELLSPRING] = _("Ogerpon-W"),
    [SPECIES_OGERPON_HEARTHFLAME] = _("Ogerpon-F"),
    [SPECIES_OGERPON_CORNERSTONE] = _("Ogerpon-R"),
    [SPECIES_TERAPAGOS_TERASTAL] = _("Terapagos-T"),
    [SPECIES_TERAPAGOS_STELLAR] = _("Terapagos-S"),
};
