...
static const u8 MAP_GROUP_COUNT[] = {5, 123, 60, 66, 4, 6, 8, 10, 6, 8, 21, 10, 8, 2, 10, 4, 2, 2, 2, 1, 1, 2, 2, 3, 2, 3, 2, 1, 1, 1, 1, 7, 5, 5, 8, 8, 5, 5, 1, 1, 1, 2, 1, 0};
...
//            break;
        case DEBUG_FLAGVAR_MENU_ITEM_TOGGLE_LOCATIONS:
            result = FlagGet(FLAG_WORLD_MAP_PALLET_TOWN) &&
                     ...
                     FlagGet(FLAG_WORLD_MAP_VIRIDIAN_FOREST) &&
                     FlagGet(FLAG_WORLD_MAP_MT_MOON_1F) &&
                     FlagGet(FLAG_WORLD_MAP_SSANNE_EXTERIOR) &&
                     FlagGet(FLAG_WORLD_MAP_UNDERGROUND_PATH_NORTH_SOUTH_TUNNEL) &&
                     FlagGet(FLAG_WORLD_MAP_UNDERGROUND_PATH_EAST_WEST_TUNNEL) &&
                     FlagGet(FLAG_WORLD_MAP_DIGLETTS_CAVE_B1F) &&
                     FlagGet(FLAG_WORLD_MAP_VICTORY_ROAD_1F) &&
                     FlagGet(FLAG_WORLD_MAP_ROCKET_HIDEOUT_B1F) &&
                     FlagGet(FLAG_WORLD_MAP_SILPH_CO_1F) &&
                     FlagGet(FLAG_WORLD_MAP_POKEMON_MANSION_1F) &&
                     FlagGet(FLAG_WORLD_MAP_SAFARI_ZONE_CENTER) &&
                     FlagGet(FLAG_WORLD_MAP_POKEMON_LEAGUE_LORELEIS_ROOM) &&
                     FlagGet(FLAG_WORLD_MAP_ROCK_TUNNEL_1F) &&
                     FlagGet(FLAG_WORLD_MAP_SEAFOAM_ISLANDS_1F) &&
                     FlagGet(FLAG_WORLD_MAP_POKEMON_TOWER_1F) &&
                     FlagGet(FLAG_WORLD_MAP_CERULEAN_CAVE_1F) &&
                     FlagGet(FLAG_WORLD_MAP_POWER_PLANT) &&
                     FlagGet(FLAG_WORLD_MAP_NAVEL_ROCK_EXTERIOR) &&
                     FlagGet(FLAG_WORLD_MAP_MT_EMBER_EXTERIOR) &&
                     FlagGet(FLAG_WORLD_MAP_THREE_ISLAND_BERRY_FOREST) &&
                     FlagGet(FLAG_WORLD_MAP_FOUR_ISLAND_ICEFALL_CAVE_ENTRANCE) &&
                     FlagGet(FLAG_WORLD_MAP_FIVE_ISLAND_ROCKET_WAREHOUSE) &&
                     FlagGet(FLAG_WORLD_MAP_TRAINER_TOWER_LOBBY) &&
                     FlagGet(FLAG_WORLD_MAP_SIX_ISLAND_DOTTED_HOLE_1F) &&
                     FlagGet(FLAG_WORLD_MAP_FIVE_ISLAND_LOST_CAVE_ENTRANCE) &&
                     FlagGet(FLAG_WORLD_MAP_SIX_ISLAND_PATTERN_BUSH) &&
                     FlagGet(FLAG_WORLD_MAP_SIX_ISLAND_ALTERING_CAVE) &&
                     FlagGet(FLAG_WORLD_MAP_SEVEN_ISLAND_TANOBY_RUINS_MONEAN_CHAMBER) &&
                     FlagGet(FLAG_WORLD_MAP_THREE_ISLAND_DUNSPARCE_TUNNEL) &&
                     FlagGet(FLAG_WORLD_MAP_SEVEN_ISLAND_SEVAULT_CANYON_TANOBY_KEY) &&
                     FlagGet(FLAG_WORLD_MAP_BIRTH_ISLAND_EXTERIOR);
            break;
...
static void DebugAction_FlagsVars_ToggleFlyFlags(u8 taskId)
{
    ...
    if (FlagGet(FLAG_WORLD_MAP_NAVEL_ROCK_EXTERIOR))
    {
        ...
        FlagClear(FLAG_WORLD_MAP_VIRIDIAN_FOREST);
        FlagClear(FLAG_WORLD_MAP_MT_MOON_1F);
        FlagClear(FLAG_WORLD_MAP_SSANNE_EXTERIOR);
        FlagClear(FLAG_WORLD_MAP_UNDERGROUND_PATH_NORTH_SOUTH_TUNNEL);
        FlagClear(FLAG_WORLD_MAP_UNDERGROUND_PATH_EAST_WEST_TUNNEL);
        FlagClear(FLAG_WORLD_MAP_DIGLETTS_CAVE_B1F);
        FlagClear(FLAG_WORLD_MAP_VICTORY_ROAD_1F);
        FlagClear(FLAG_WORLD_MAP_ROCKET_HIDEOUT_B1F);
        FlagClear(FLAG_WORLD_MAP_SILPH_CO_1F);
        FlagClear(FLAG_WORLD_MAP_POKEMON_MANSION_1F);
        FlagClear(FLAG_WORLD_MAP_SAFARI_ZONE_CENTER);
        FlagClear(FLAG_WORLD_MAP_POKEMON_LEAGUE_LORELEIS_ROOM);
        FlagClear(FLAG_WORLD_MAP_ROCK_TUNNEL_1F);
        FlagClear(FLAG_WORLD_MAP_SEAFOAM_ISLANDS_1F);
        FlagClear(FLAG_WORLD_MAP_POKEMON_TOWER_1F);
        FlagClear(FLAG_WORLD_MAP_CERULEAN_CAVE_1F);
        FlagClear(FLAG_WORLD_MAP_POWER_PLANT);
        FlagClear(FLAG_WORLD_MAP_NAVEL_ROCK_EXTERIOR);
        FlagClear(FLAG_WORLD_MAP_MT_EMBER_EXTERIOR);
        FlagClear(FLAG_WORLD_MAP_THREE_ISLAND_BERRY_FOREST);
        FlagClear(FLAG_WORLD_MAP_FOUR_ISLAND_ICEFALL_CAVE_ENTRANCE);
        FlagClear(FLAG_WORLD_MAP_FIVE_ISLAND_ROCKET_WAREHOUSE);
        FlagClear(FLAG_WORLD_MAP_TRAINER_TOWER_LOBBY);
        FlagClear(FLAG_WORLD_MAP_SIX_ISLAND_DOTTED_HOLE_1F);
        FlagClear(FLAG_WORLD_MAP_FIVE_ISLAND_LOST_CAVE_ENTRANCE);
        FlagClear(FLAG_WORLD_MAP_SIX_ISLAND_PATTERN_BUSH);
        FlagClear(FLAG_WORLD_MAP_SIX_ISLAND_ALTERING_CAVE);
        FlagClear(FLAG_WORLD_MAP_SEVEN_ISLAND_TANOBY_RUINS_MONEAN_CHAMBER);
        FlagClear(FLAG_WORLD_MAP_THREE_ISLAND_DUNSPARCE_TUNNEL);
        FlagClear(FLAG_WORLD_MAP_SEVEN_ISLAND_SEVAULT_CANYON_TANOBY_KEY);
        FlagClear(FLAG_WORLD_MAP_BIRTH_ISLAND_EXTERIOR);
    }
    else
    {
        PlaySE(SE_PC_LOGIN);
...
#define SOUND_LIST_BGM \
    ...
    X(367, "MUS-LEVEL-UP") \
    X(368, "MUS-HEAL") \
    X(369, "MUS-OBTAIN-BADGE") \
    X(370, "MUS-OBTAIN-ITEM") \
    X(371, "MUS-EVOLVED") \
    X(372, "MUS-OBTAIN-TMHM") \
    X(MUS_LILYCOVE_MUSEUM, "MUS-LILYCOVE-MUSEUM") \
    X(MUS_ROUTE122, "MUS-ROUTE122") \
    X(MUS_OCEANIC_MUSEUM, "MUS-OCEANIC-MUSEUM") \
    X(376, "MUS-EVOLUTION-INTRO") \
    X(377, "MUS-EVOLUTION") \
    X(378, "MUS-MOVE-DELETED") \
    ...
    X(387, "MUS-OBTAIN-BERRY") \
    X(MUS_AWAKEN_LEGEND, "MUS-AWAKEN-LEGEND") \
    X(389, "MUS-SLOTS-JACKPOT") \
    X(390, "MUS-SLOTS-WIN") \
    X(391, "MUS-TOO-BAD") \
    ...
    X(476, "MUS-VS-TRAINER") \
    X(477, "MUS-VS-GYM-LEADER") \
    ...
    X(MUS_PENIS, "MUS-PENIS") \
    X(MUS_RBYCHAMP, "MUS-RBYCHAMP") \
    ...
    X(MUS_UNTITLED, "MUS-UNTITLED") \
    X(MUS_CRITTER_BOSS, "MUS-CRITTER-BOSS") \
