...
const u8 gMoveDescription_Placeholder[] = _("Not implemented\nyet.");
...
const u8 *const gMoveDescriptionPointers[MOVES_COUNT - 1] = {
    ...
    [MOVE_ROOST - 1] = gMoveDescription_Placeholder,
    [MOVE_GRAVITY - 1] = gMoveDescription_Placeholder,
    [MOVE_MIRACLE_EYE - 1] = gMoveDescription_Placeholder,
    [MOVE_WAKE_UP_SLAP - 1] = gMoveDescription_Placeholder,
    [MOVE_HAMMER_ARM - 1] = gMoveDescription_Placeholder,
    [MOVE_GYRO_BALL - 1] = gMoveDescription_Placeholder,
    [MOVE_HEALING_WISH - 1] = gMoveDescription_Placeholder,
    [MOVE_BRINE - 1] = gMoveDescription_Placeholder,
    [MOVE_NATURAL_GIFT - 1] = gMoveDescription_Placeholder,
    [MOVE_FEINT - 1] = gMoveDescription_Placeholder,
    [MOVE_PLUCK - 1] = gMoveDescription_Placeholder,
    [MOVE_TAILWIND - 1] = gMoveDescription_Placeholder,
    [MOVE_ACUPRESSURE - 1] = gMoveDescription_Placeholder,
    [MOVE_METAL_BURST - 1] = gMoveDescription_Placeholder,
    [MOVE_U_TURN - 1] = gMoveDescription_Placeholder,
    [MOVE_CLOSE_COMBAT - 1] = gMoveDescription_Placeholder,
    [MOVE_PAYBACK - 1] = gMoveDescription_Placeholder,
    [MOVE_ASSURANCE - 1] = gMoveDescription_Placeholder,
    [MOVE_EMBARGO - 1] = gMoveDescription_Placeholder,
    [MOVE_FLING - 1] = gMoveDescription_Placeholder,
    [MOVE_PSYCHO_SHIFT - 1] = gMoveDescription_Placeholder,
    [MOVE_TRUMP_CARD - 1] = gMoveDescription_Placeholder,
    [MOVE_HEAL_BLOCK - 1] = gMoveDescription_Placeholder,
    [MOVE_WRING_OUT - 1] = gMoveDescription_Placeholder,
    [MOVE_POWER_TRICK - 1] = gMoveDescription_Placeholder,
    [MOVE_GASTRO_ACID - 1] = gMoveDescription_Placeholder,
    [MOVE_LUCKY_CHANT - 1] = gMoveDescription_Placeholder,
    [MOVE_ME_FIRST - 1] = gMoveDescription_Placeholder,
    [MOVE_COPYCAT - 1] = gMoveDescription_Placeholder,
    [MOVE_POWER_SWAP - 1] = gMoveDescription_Placeholder,
    [MOVE_GUARD_SWAP - 1] = gMoveDescription_Placeholder,
    [MOVE_PUNISHMENT - 1] = gMoveDescription_Placeholder,
    [MOVE_LAST_RESORT - 1] = gMoveDescription_Placeholder,
    [MOVE_WORRY_SEED - 1] = gMoveDescription_Placeholder,
    [MOVE_SUCKER_PUNCH - 1] = gMoveDescription_Placeholder,
    [MOVE_TOXIC_SPIKES - 1] = gMoveDescription_Placeholder,
    [MOVE_HEART_SWAP - 1] = gMoveDescription_Placeholder,
    [MOVE_AQUA_RING - 1] = gMoveDescription_Placeholder,
    [MOVE_MAGNET_RISE - 1] = gMoveDescription_Placeholder,
    [MOVE_FLARE_BLITZ - 1] = gMoveDescription_Placeholder,
    [MOVE_FORCE_PALM - 1] = gMoveDescription_Placeholder,
    [MOVE_AURA_SPHERE - 1] = gMoveDescription_Placeholder,
    [MOVE_ROCK_POLISH - 1] = gMoveDescription_Placeholder,
    [MOVE_POISON_JAB - 1] = gMoveDescription_Placeholder,
    [MOVE_DARK_PULSE - 1] = gMoveDescription_Placeholder,
    [MOVE_NIGHT_SLASH - 1] = gMoveDescription_Placeholder,
    [MOVE_AQUA_TAIL - 1] = gMoveDescription_Placeholder,
    [MOVE_SEED_BOMB - 1] = gMoveDescription_Placeholder,
    [MOVE_AIR_SLASH - 1] = gMoveDescription_AirSlash,
    [MOVE_X_SCISSOR - 1] = gMoveDescription_Placeholder,
    [MOVE_BUG_BUZZ - 1] = gMoveDescription_Placeholder,
    [MOVE_DRAGON_PULSE - 1] = gMoveDescription_Placeholder,
    [MOVE_DRAGON_RUSH - 1] = gMoveDescription_Placeholder,
    [MOVE_POWER_GEM - 1] = gMoveDescription_Placeholder,
    [MOVE_DRAIN_PUNCH - 1] = gMoveDescription_Placeholder,
    [MOVE_VACUUM_WAVE - 1] = gMoveDescription_Placeholder,
    [MOVE_FOCUS_BLAST - 1] = gMoveDescription_Placeholder,
    [MOVE_ENERGY_BALL - 1] = gMoveDescription_Placeholder,
    [MOVE_BRAVE_BIRD - 1] = gMoveDescription_Placeholder,
    [MOVE_EARTH_POWER - 1] = gMoveDescription_Placeholder,
    [MOVE_SWITCHEROO - 1] = gMoveDescription_Placeholder,
    [MOVE_GIGA_IMPACT - 1] = gMoveDescription_Placeholder,
    [MOVE_NASTY_PLOT - 1] = gMoveDescription_Placeholder,
    [MOVE_BULLET_PUNCH - 1] = gMoveDescription_Placeholder,
    [MOVE_AVALANCHE - 1] = gMoveDescription_Placeholder,
    [MOVE_ICE_SHARD - 1] = gMoveDescription_Placeholder,
    [MOVE_SHADOW_CLAW - 1] = gMoveDescription_Placeholder,
    [MOVE_THUNDER_FANG - 1] = gMoveDescription_Placeholder,
    [MOVE_ICE_FANG - 1] = gMoveDescription_Placeholder,
    [MOVE_FIRE_FANG - 1] = gMoveDescription_Placeholder,
    [MOVE_SHADOW_SNEAK - 1] = gMoveDescription_ShadowSneak,
    [MOVE_MUD_BOMB - 1] = gMoveDescription_Placeholder,
    [MOVE_PSYCHO_CUT - 1] = gMoveDescription_Placeholder,
    [MOVE_ZEN_HEADBUTT - 1] = gMoveDescription_Placeholder,
    [MOVE_MIRROR_SHOT - 1] = gMoveDescription_Placeholder,
    [MOVE_FLASH_CANNON - 1] = gMoveDescription_Placeholder,
    [MOVE_ROCK_CLIMB - 1] = gMoveDescription_Placeholder,
    [MOVE_DEFOG - 1] = gMoveDescription_Placeholder,
    [MOVE_TRICK_ROOM - 1] = gMoveDescription_Placeholder,
    [MOVE_DRACO_METEOR - 1] = gMoveDescription_Placeholder,
    [MOVE_DISCHARGE - 1] = gMoveDescription_Placeholder,
    [MOVE_LAVA_PLUME - 1] = gMoveDescription_Placeholder,
    [MOVE_LEAF_STORM - 1] = gMoveDescription_LeafStorm,
    [MOVE_POWER_WHIP - 1] = gMoveDescription_Placeholder,
    [MOVE_ROCK_WRECKER - 1] = gMoveDescription_Placeholder,
    [MOVE_CROSS_POISON - 1] = gMoveDescription_Placeholder,
    [MOVE_GUNK_SHOT - 1] = gMoveDescription_Placeholder,
    [MOVE_IRON_HEAD - 1] = gMoveDescription_Placeholder,
    [MOVE_MAGNET_BOMB - 1] = gMoveDescription_Placeholder,
    [MOVE_STONE_EDGE - 1] = gMoveDescription_Placeholder,
    [MOVE_CAPTIVATE - 1] = gMoveDescription_Placeholder,
    [MOVE_STEALTH_ROCK - 1] = gMoveDescription_Placeholder,
    [MOVE_GRASS_KNOT - 1] = gMoveDescription_Placeholder,
    [MOVE_CHATTER - 1] = gMoveDescription_Placeholder,
    [MOVE_JUDGMENT - 1] = gMoveDescription_Placeholder,
    [MOVE_BUG_BITE - 1] = gMoveDescription_Placeholder,
    [MOVE_CHARGE_BEAM - 1] = gMoveDescription_Placeholder,
    [MOVE_WOOD_HAMMER - 1] = gMoveDescription_Placeholder,
    [MOVE_AQUA_JET - 1] = gMoveDescription_Placeholder,
    [MOVE_ATTACK_ORDER - 1] = gMoveDescription_Placeholder,
    [MOVE_DEFEND_ORDER - 1] = gMoveDescription_Placeholder,
    [MOVE_HEAL_ORDER - 1] = gMoveDescription_Placeholder,
    [MOVE_HEAD_SMASH - 1] = gMoveDescription_Placeholder,
    [MOVE_DOUBLE_HIT - 1] = gMoveDescription_Placeholder,
    [MOVE_ROAR_OF_TIME - 1] = gMoveDescription_Placeholder,
    [MOVE_SPACIAL_REND - 1] = gMoveDescription_Placeholder,
    [MOVE_LUNAR_DANCE - 1] = gMoveDescription_Placeholder,
    [MOVE_CRUSH_GRIP - 1] = gMoveDescription_Placeholder,
    [MOVE_MAGMA_STORM - 1] = gMoveDescription_Placeholder,
    [MOVE_DARK_VOID - 1] = gMoveDescription_Placeholder,
    [MOVE_SEED_FLARE - 1] = gMoveDescription_Placeholder,
    [MOVE_OMINOUS_WIND - 1] = gMoveDescription_Placeholder,
    [MOVE_SHADOW_FORCE - 1] = gMoveDescription_Placeholder,
    [MOVE_HONE_CLAWS - 1] = gMoveDescription_Placeholder,
    [MOVE_WIDE_GUARD - 1] = gMoveDescription_Placeholder,
    [MOVE_GUARD_SPLIT - 1] = gMoveDescription_Placeholder,
    [MOVE_POWER_SPLIT - 1] = gMoveDescription_Placeholder,
    [MOVE_WONDER_ROOM - 1] = gMoveDescription_Placeholder,
    [MOVE_PSYSHOCK - 1] = gMoveDescription_Placeholder,
    [MOVE_VENOSHOCK - 1] = gMoveDescription_Placeholder,
    [MOVE_AUTOTOMIZE - 1] = gMoveDescription_Placeholder,
    [MOVE_RAGE_POWDER - 1] = gMoveDescription_Placeholder,
    [MOVE_TELEKINESIS - 1] = gMoveDescription_Placeholder,
    [MOVE_MAGIC_ROOM - 1] = gMoveDescription_Placeholder,
    [MOVE_SMACK_DOWN - 1] = gMoveDescription_Placeholder,
    [MOVE_STORM_THROW - 1] = gMoveDescription_Placeholder,
    [MOVE_FLAME_BURST - 1] = gMoveDescription_Placeholder,
    [MOVE_SLUDGE_WAVE - 1] = gMoveDescription_Placeholder,
    [MOVE_QUIVER_DANCE - 1] = gMoveDescription_Placeholder,
    [MOVE_HEAVY_SLAM - 1] = gMoveDescription_Placeholder,
    [MOVE_SYNCHRONOISE - 1] = gMoveDescription_Placeholder,
    [MOVE_ELECTRO_BALL - 1] = gMoveDescription_Placeholder,
    [MOVE_SOAK - 1] = gMoveDescription_Placeholder,
    [MOVE_FLAME_CHARGE - 1] = gMoveDescription_Placeholder,
    [MOVE_COIL - 1] = gMoveDescription_Placeholder,
    [MOVE_LOW_SWEEP - 1] = gMoveDescription_Placeholder,
    [MOVE_ACID_SPRAY - 1] = gMoveDescription_Placeholder,
    [MOVE_FOUL_PLAY - 1] = gMoveDescription_Placeholder,
    [MOVE_SIMPLE_BEAM - 1] = gMoveDescription_Placeholder,
    [MOVE_ENTRAINMENT - 1] = gMoveDescription_Placeholder,
    [MOVE_AFTER_YOU - 1] = gMoveDescription_Placeholder,
    [MOVE_ROUND - 1] = gMoveDescription_Placeholder,
    [MOVE_ECHOED_VOICE - 1] = gMoveDescription_Placeholder,
    [MOVE_CHIP_AWAY - 1] = gMoveDescription_Placeholder,
    [MOVE_CLEAR_SMOG - 1] = gMoveDescription_Placeholder,
    [MOVE_STORED_POWER - 1] = gMoveDescription_Placeholder,
    [MOVE_QUICK_GUARD - 1] = gMoveDescription_Placeholder,
    [MOVE_ALLY_SWITCH - 1] = gMoveDescription_Placeholder,
    [MOVE_SCALD - 1] = gMoveDescription_Placeholder,
    [MOVE_SHELL_SMASH - 1] = gMoveDescription_Placeholder,
    [MOVE_HEAL_PULSE - 1] = gMoveDescription_Placeholder,
    [MOVE_HEX - 1] = gMoveDescription_Placeholder,
    [MOVE_SKY_DROP - 1] = gMoveDescription_Placeholder,
    [MOVE_SHIFT_GEAR - 1] = gMoveDescription_Placeholder,
    [MOVE_CIRCLE_THROW - 1] = gMoveDescription_Placeholder,
    [MOVE_INCINERATE - 1] = gMoveDescription_Placeholder,
    [MOVE_QUASH - 1] = gMoveDescription_Placeholder,
    [MOVE_ACROBATICS - 1] = gMoveDescription_Placeholder,
    [MOVE_REFLECT_TYPE - 1] = gMoveDescription_Placeholder,
    [MOVE_RETALIATE - 1] = gMoveDescription_Placeholder,
    [MOVE_FINAL_GAMBIT - 1] = gMoveDescription_Placeholder,
    [MOVE_BESTOW - 1] = gMoveDescription_Placeholder,
    [MOVE_INFERNO - 1] = gMoveDescription_Placeholder,
    [MOVE_WATER_PLEDGE - 1] = gMoveDescription_Placeholder,
    [MOVE_FIRE_PLEDGE - 1] = gMoveDescription_Placeholder,
    [MOVE_GRASS_PLEDGE - 1] = gMoveDescription_Placeholder,
    [MOVE_VOLT_SWITCH - 1] = gMoveDescription_Placeholder,
    [MOVE_STRUGGLE_BUG - 1] = gMoveDescription_StruggleBug,
    [MOVE_BULLDOZE - 1] = gMoveDescription_Placeholder,
    [MOVE_FROST_BREATH - 1] = gMoveDescription_Placeholder,
    [MOVE_DRAGON_TAIL - 1] = gMoveDescription_Placeholder,
    [MOVE_WORK_UP - 1] = gMoveDescription_Placeholder,
    [MOVE_ELECTROWEB - 1] = gMoveDescription_Placeholder,
    [MOVE_WILD_CHARGE - 1] = gMoveDescription_Placeholder,
    [MOVE_DRILL_RUN - 1] = gMoveDescription_Placeholder,
    [MOVE_DUAL_CHOP - 1] = gMoveDescription_Placeholder,
    [MOVE_HEART_STAMP - 1] = gMoveDescription_Placeholder,
    [MOVE_HORN_LEECH - 1] = gMoveDescription_Placeholder,
    [MOVE_SACRED_SWORD - 1] = gMoveDescription_Placeholder,
    [MOVE_RAZOR_SHELL - 1] = gMoveDescription_Placeholder,
    [MOVE_HEAT_CRASH - 1] = gMoveDescription_Placeholder,
    [MOVE_LEAF_TORNADO - 1] = gMoveDescription_Placeholder,
    [MOVE_STEAMROLLER - 1] = gMoveDescription_Placeholder,
    [MOVE_COTTON_GUARD - 1] = gMoveDescription_Placeholder,
    [MOVE_NIGHT_DAZE - 1] = gMoveDescription_Placeholder,
    [MOVE_PSYSTRIKE - 1] = gMoveDescription_Placeholder,
    [MOVE_TAIL_SLAP - 1] = gMoveDescription_Placeholder,
    [MOVE_HURRICANE - 1] = gMoveDescription_Placeholder,
    [MOVE_HEAD_CHARGE - 1] = gMoveDescription_Placeholder,
    [MOVE_GEAR_GRIND - 1] = gMoveDescription_Placeholder,
    [MOVE_SEARING_SHOT - 1] = gMoveDescription_Placeholder,
    [MOVE_TECHNO_BLAST - 1] = gMoveDescription_Placeholder,
    [MOVE_RELIC_SONG - 1] = gMoveDescription_Placeholder,
    [MOVE_SECRET_SWORD - 1] = gMoveDescription_Placeholder,
    [MOVE_GLACIATE - 1] = gMoveDescription_Placeholder,
    [MOVE_BOLT_STRIKE - 1] = gMoveDescription_Placeholder,
    [MOVE_BLUE_FLARE - 1] = gMoveDescription_Placeholder,
    [MOVE_FIERY_DANCE - 1] = gMoveDescription_Placeholder,
    [MOVE_FREEZE_SHOCK - 1] = gMoveDescription_Placeholder,
    [MOVE_ICE_BURN - 1] = gMoveDescription_Placeholder,
    [MOVE_SNARL - 1] = gMoveDescription_Placeholder,
    [MOVE_ICICLE_CRASH - 1] = gMoveDescription_Placeholder,
    [MOVE_V_CREATE - 1] = gMoveDescription_Placeholder,
    [MOVE_FUSION_FLARE - 1] = gMoveDescription_Placeholder,
    [MOVE_FUSION_BOLT - 1] = gMoveDescription_Placeholder,
    [MOVE_FLYING_PRESS - 1] = gMoveDescription_Placeholder,
    [MOVE_MAT_BLOCK - 1] = gMoveDescription_Placeholder,
    [MOVE_BELCH - 1] = gMoveDescription_Placeholder,
    [MOVE_ROTOTILLER - 1] = gMoveDescription_Placeholder,
    [MOVE_STICKY_WEB - 1] = gMoveDescription_Placeholder,
    [MOVE_FELL_STINGER - 1] = gMoveDescription_Placeholder,
    [MOVE_PHANTOM_FORCE - 1] = gMoveDescription_Placeholder,
    [MOVE_TRICK_OR_TREAT - 1] = gMoveDescription_Placeholder,
    [MOVE_NOBLE_ROAR - 1] = gMoveDescription_Placeholder,
    [MOVE_ION_DELUGE - 1] = gMoveDescription_Placeholder,
    [MOVE_PARABOLIC_CHARGE - 1] = gMoveDescription_Placeholder,
    [MOVE_FORESTS_CURSE - 1] = gMoveDescription_Placeholder,
    [MOVE_PETAL_BLIZZARD - 1] = gMoveDescription_Placeholder,
    [MOVE_FREEZE_DRY - 1] = gMoveDescription_Placeholder,
    [MOVE_DISARMING_VOICE - 1] = gMoveDescription_DisarmingVoice,
    [MOVE_PARTING_SHOT - 1] = gMoveDescription_Placeholder,
    [MOVE_TOPSY_TURVY - 1] = gMoveDescription_Placeholder,
    [MOVE_DRAINING_KISS - 1] = gMoveDescription_DrainingKiss,
    [MOVE_CRAFTY_SHIELD - 1] = gMoveDescription_Placeholder,
    [MOVE_FLOWER_SHIELD - 1] = gMoveDescription_Placeholder,
    [MOVE_GRASSY_TERRAIN - 1] = gMoveDescription_Placeholder,
    [MOVE_MISTY_TERRAIN - 1] = gMoveDescription_Placeholder,
    [MOVE_ELECTRIFY - 1] = gMoveDescription_Placeholder,
    ...
    [MOVE_BOOMBURST - 1] = gMoveDescription_Placeholder,
    [MOVE_FAIRY_LOCK - 1] = gMoveDescription_Placeholder,
    [MOVE_KINGS_SHIELD - 1] = gMoveDescription_Placeholder,
    [MOVE_PLAY_NICE - 1] = gMoveDescription_PlayNice,
    [MOVE_CONFIDE - 1] = gMoveDescription_Placeholder,
    [MOVE_DIAMOND_STORM - 1] = gMoveDescription_Placeholder,
    [MOVE_STEAM_ERUPTION - 1] = gMoveDescription_Placeholder,
    [MOVE_HYPERSPACE_HOLE - 1] = gMoveDescription_Placeholder,
    [MOVE_WATER_SHURIKEN - 1] = gMoveDescription_Placeholder,
    [MOVE_MYSTICAL_FIRE - 1] = gMoveDescription_Placeholder,
    [MOVE_SPIKY_SHIELD - 1] = gMoveDescription_Placeholder,
    [MOVE_AROMATIC_MIST - 1] = gMoveDescription_Placeholder,
    [MOVE_EERIE_IMPULSE - 1] = gMoveDescription_Placeholder,
    [MOVE_VENOM_DRENCH - 1] = gMoveDescription_Placeholder,
    [MOVE_POWDER - 1] = gMoveDescription_Placeholder,
    [MOVE_GEOMANCY - 1] = gMoveDescription_Placeholder,
    [MOVE_MAGNETIC_FLUX - 1] = gMoveDescription_Placeholder,
    [MOVE_HAPPY_HOUR - 1] = gMoveDescription_Placeholder,
    [MOVE_ELECTRIC_TERRAIN - 1] = gMoveDescription_Placeholder,
    [MOVE_DAZZLING_GLEAM - 1] = gMoveDescription_DazzlingGleam,
    [MOVE_CELEBRATE - 1] = gMoveDescription_Placeholder,
    [MOVE_HOLD_HANDS - 1] = gMoveDescription_Placeholder,
    [MOVE_BABY_DOLL_EYES - 1] = gMoveDescription_Placeholder,
    [MOVE_NUZZLE - 1] = gMoveDescription_Placeholder,
    [MOVE_HOLD_BACK - 1] = gMoveDescription_Placeholder,
    [MOVE_INFESTATION - 1] = gMoveDescription_Placeholder,
    [MOVE_POWER_UP_PUNCH - 1] = gMoveDescription_Placeholder,
    [MOVE_OBLIVION_WING - 1] = gMoveDescription_Placeholder,
    [MOVE_THOUSAND_ARROWS - 1] = gMoveDescription_Placeholder,
    [MOVE_THOUSAND_WAVES - 1] = gMoveDescription_Placeholder,
    [MOVE_LANDS_WRATH - 1] = gMoveDescription_Placeholder,
    [MOVE_LIGHT_OF_RUIN - 1] = gMoveDescription_Placeholder,
    [MOVE_ORIGIN_PULSE - 1] = gMoveDescription_Placeholder,
    [MOVE_PRECIPICE_BLADES - 1] = gMoveDescription_Placeholder,
    [MOVE_DRAGON_ASCENT - 1] = gMoveDescription_Placeholder,
    [MOVE_HYPERSPACE_FURY - 1] = gMoveDescription_Placeholder,
    [MOVE_SHORE_UP - 1] = gMoveDescription_Placeholder,
    [MOVE_FIRST_IMPRESSION - 1] = gMoveDescription_Placeholder,
    [MOVE_BANEFUL_BUNKER - 1] = gMoveDescription_Placeholder,
    [MOVE_SPIRIT_SHACKLE - 1] = gMoveDescription_Placeholder,
    [MOVE_DARKEST_LARIAT - 1] = gMoveDescription_Placeholder,
    [MOVE_SPARKLING_ARIA - 1] = gMoveDescription_Placeholder,
    [MOVE_ICE_HAMMER - 1] = gMoveDescription_Placeholder,
    [MOVE_FLORAL_HEALING - 1] = gMoveDescription_Placeholder,
    [MOVE_HIGH_HORSEPOWER - 1] = gMoveDescription_Placeholder,
    [MOVE_STRENGTH_SAP - 1] = gMoveDescription_Placeholder,
    [MOVE_SOLAR_BLADE - 1] = gMoveDescription_Placeholder,
    [MOVE_LEAFAGE - 1] = gMoveDescription_Placeholder,
    [MOVE_SPOTLIGHT - 1] = gMoveDescription_Placeholder,
    [MOVE_TOXIC_THREAD - 1] = gMoveDescription_Placeholder,
    [MOVE_LASER_FOCUS - 1] = gMoveDescription_Placeholder,
    [MOVE_GEAR_UP - 1] = gMoveDescription_Placeholder,
    [MOVE_THROAT_CHOP - 1] = gMoveDescription_Placeholder,
    [MOVE_POLLEN_PUFF - 1] = gMoveDescription_Placeholder,
    [MOVE_ANCHOR_SHOT - 1] = gMoveDescription_Placeholder,
    [MOVE_PSYCHIC_TERRAIN - 1] = gMoveDescription_Placeholder,
    [MOVE_LUNGE - 1] = gMoveDescription_Placeholder,
    [MOVE_FIRE_LASH - 1] = gMoveDescription_Placeholder,
    [MOVE_POWER_TRIP - 1] = gMoveDescription_Placeholder,
    [MOVE_BURN_UP - 1] = gMoveDescription_Placeholder,
    [MOVE_SPEED_SWAP - 1] = gMoveDescription_Placeholder,
    [MOVE_SMART_STRIKE - 1] = gMoveDescription_Placeholder,
    [MOVE_PURIFY - 1] = gMoveDescription_Placeholder,
    [MOVE_REVELATION_DANCE - 1] = gMoveDescription_Placeholder,
    [MOVE_CORE_ENFORCER - 1] = gMoveDescription_Placeholder,
    [MOVE_TROP_KICK - 1] = gMoveDescription_Placeholder,
    [MOVE_INSTRUCT - 1] = gMoveDescription_Placeholder,
    [MOVE_BEAK_BLAST - 1] = gMoveDescription_Placeholder,
    [MOVE_CLANGING_SCALES - 1] = gMoveDescription_Placeholder,
    [MOVE_DRAGON_HAMMER - 1] = gMoveDescription_Placeholder,
    [MOVE_BRUTAL_SWING - 1] = gMoveDescription_Placeholder,
    [MOVE_AURORA_VEIL - 1] = gMoveDescription_Placeholder,
    [MOVE_SHELL_TRAP - 1] = gMoveDescription_Placeholder,
    [MOVE_FLEUR_CANNON - 1] = gMoveDescription_Placeholder,
    [MOVE_PSYCHIC_FANGS - 1] = gMoveDescription_Placeholder,
    [MOVE_STOMPING_TANTRUM - 1] = gMoveDescription_Placeholder,
    [MOVE_SHADOW_BONE - 1] = gMoveDescription_Placeholder,
    [MOVE_ACCELEROCK - 1] = gMoveDescription_Placeholder,
    [MOVE_LIQUIDATION - 1] = gMoveDescription_Placeholder,
    [MOVE_PRISMATIC_LASER - 1] = gMoveDescription_Placeholder,
    [MOVE_SPECTRAL_THIEF - 1] = gMoveDescription_Placeholder,
    [MOVE_SUNSTEEL_STRIKE - 1] = gMoveDescription_Placeholder,
    [MOVE_MOONGEIST_BEAM - 1] = gMoveDescription_Placeholder,
    [MOVE_TEARFUL_LOOK - 1] = gMoveDescription_Placeholder,
    [MOVE_ZING_ZAP - 1] = gMoveDescription_Placeholder,
    [MOVE_NATURES_MADNESS - 1] = gMoveDescription_Placeholder,
    [MOVE_MULTI_ATTACK - 1] = gMoveDescription_Placeholder,
    [MOVE_MIND_BLOWN - 1] = gMoveDescription_Placeholder,
    [MOVE_PLASMA_FISTS - 1] = gMoveDescription_Placeholder,
    [MOVE_PHOTON_GEYSER - 1] = gMoveDescription_Placeholder,
    [MOVE_ZIPPY_ZAP - 1] = gMoveDescription_Placeholder,
    [MOVE_SPLISHY_SPLASH - 1] = gMoveDescription_Placeholder,
    [MOVE_FLOATY_FALL - 1] = gMoveDescription_Placeholder,
    [MOVE_PIKA_PAPOW - 1] = gMoveDescription_Placeholder,
    [MOVE_BOUNCY_BUBBLE - 1] = gMoveDescription_Placeholder,
    [MOVE_BUZZY_BUZZ - 1] = gMoveDescription_Placeholder,
    [MOVE_SIZZLY_SLIDE - 1] = gMoveDescription_Placeholder,
    [MOVE_GLITZY_GLOW - 1] = gMoveDescription_Placeholder,
    [MOVE_BADDY_BAD - 1] = gMoveDescription_Placeholder,
    [MOVE_SAPPY_SEED - 1] = gMoveDescription_Placeholder,
    [MOVE_FREEZY_FROST - 1] = gMoveDescription_Placeholder,
    [MOVE_SPARKLY_SWIRL - 1] = gMoveDescription_Placeholder,
    [MOVE_VEEVEE_VOLLEY - 1] = gMoveDescription_Placeholder,
    [MOVE_DOUBLE_IRON_BASH - 1] = gMoveDescription_Placeholder,
    [MOVE_DYNAMAX_CANNON - 1] = gMoveDescription_Placeholder,
    [MOVE_SNIPE_SHOT - 1] = gMoveDescription_Placeholder,
    [MOVE_JAW_LOCK - 1] = gMoveDescription_Placeholder,
    [MOVE_STUFF_CHEEKS - 1] = gMoveDescription_Placeholder,
    [MOVE_NO_RETREAT - 1] = gMoveDescription_Placeholder,
    [MOVE_TAR_SHOT - 1] = gMoveDescription_Placeholder,
    [MOVE_MAGIC_POWDER - 1] = gMoveDescription_Placeholder,
    [MOVE_DRAGON_DARTS - 1] = gMoveDescription_Placeholder,
    [MOVE_TEATIME - 1] = gMoveDescription_Placeholder,
    [MOVE_OCTOLOCK - 1] = gMoveDescription_Placeholder,
    [MOVE_BOLT_BEAK - 1] = gMoveDescription_Placeholder,
    [MOVE_FISHIOUS_REND - 1] = gMoveDescription_Placeholder,
    [MOVE_COURT_CHANGE - 1] = gMoveDescription_Placeholder,
    [MOVE_CLANGOROUS_SOUL - 1] = gMoveDescription_Placeholder,
    [MOVE_BODY_PRESS - 1] = gMoveDescription_Placeholder,
    [MOVE_DECORATE - 1] = gMoveDescription_Placeholder,
    [MOVE_DRUM_BEATING - 1] = gMoveDescription_Placeholder,
    [MOVE_SNAP_TRAP - 1] = gMoveDescription_Placeholder,
    [MOVE_PYRO_BALL - 1] = gMoveDescription_Placeholder,
    [MOVE_BEHEMOTH_BLADE - 1] = gMoveDescription_Placeholder,
    [MOVE_BEHEMOTH_BASH - 1] = gMoveDescription_Placeholder,
    [MOVE_AURA_WHEEL - 1] = gMoveDescription_Placeholder,
    [MOVE_BREAKING_SWIPE - 1] = gMoveDescription_Placeholder,
    [MOVE_BRANCH_POKE - 1] = gMoveDescription_Placeholder,
    [MOVE_OVERDRIVE - 1] = gMoveDescription_Placeholder,
    [MOVE_APPLE_ACID - 1] = gMoveDescription_Placeholder,
    [MOVE_GRAV_APPLE - 1] = gMoveDescription_Placeholder,
    [MOVE_SPIRIT_BREAK - 1] = gMoveDescription_Placeholder,
    [MOVE_STRANGE_STEAM - 1] = gMoveDescription_Placeholder,
    [MOVE_LIFE_DEW - 1] = gMoveDescription_Placeholder,
    [MOVE_OBSTRUCT - 1] = gMoveDescription_Placeholder,
    [MOVE_FALSE_SURRENDER - 1] = gMoveDescription_Placeholder,
    [MOVE_METEOR_ASSAULT - 1] = gMoveDescription_Placeholder,
    [MOVE_ETERNABEAM - 1] = gMoveDescription_Placeholder,
    [MOVE_STEEL_BEAM - 1] = gMoveDescription_Placeholder,
    [MOVE_EXPANDING_FORCE - 1] = gMoveDescription_Placeholder,
    [MOVE_STEEL_ROLLER - 1] = gMoveDescription_Placeholder,
    [MOVE_SCALE_SHOT - 1] = gMoveDescription_Placeholder,
    [MOVE_METEOR_BEAM - 1] = gMoveDescription_Placeholder,
    [MOVE_SHELL_SIDE_ARM - 1] = gMoveDescription_Placeholder,
    [MOVE_MISTY_EXPLOSION - 1] = gMoveDescription_Placeholder,
    [MOVE_GRASSY_GLIDE - 1] = gMoveDescription_Placeholder,
    [MOVE_RISING_VOLTAGE - 1] = gMoveDescription_Placeholder,
    [MOVE_TERRAIN_PULSE - 1] = gMoveDescription_Placeholder,
    [MOVE_SKITTER_SMACK - 1] = gMoveDescription_Placeholder,
    [MOVE_BURNING_JEALOUSY - 1] = gMoveDescription_Placeholder,
    [MOVE_LASH_OUT - 1] = gMoveDescription_Placeholder,
    [MOVE_POLTERGEIST - 1] = gMoveDescription_Placeholder,
    [MOVE_CORROSIVE_GAS - 1] = gMoveDescription_Placeholder,
    [MOVE_COACHING - 1] = gMoveDescription_Placeholder,
    [MOVE_FLIP_TURN - 1] = gMoveDescription_Placeholder,
    [MOVE_TRIPLE_AXEL - 1] = gMoveDescription_Placeholder,
    [MOVE_DUAL_WINGBEAT - 1] = gMoveDescription_Placeholder,
    [MOVE_SCORCHING_SANDS - 1] = gMoveDescription_Placeholder,
    [MOVE_JUNGLE_HEALING - 1] = gMoveDescription_Placeholder,
    [MOVE_WICKED_BLOW - 1] = gMoveDescription_Placeholder,
    [MOVE_SURGING_STRIKES - 1] = gMoveDescription_Placeholder,
    [MOVE_THUNDER_CAGE - 1] = gMoveDescription_Placeholder,
    [MOVE_DRAGON_ENERGY - 1] = gMoveDescription_Placeholder,
    [MOVE_FREEZING_GLARE - 1] = gMoveDescription_Placeholder,
    [MOVE_FIERY_WRATH - 1] = gMoveDescription_Placeholder,
    [MOVE_THUNDEROUS_KICK - 1] = gMoveDescription_Placeholder,
    [MOVE_GLACIAL_LANCE - 1] = gMoveDescription_Placeholder,
    [MOVE_ASTRAL_BARRAGE - 1] = gMoveDescription_Placeholder,
    [MOVE_EERIE_SPELL - 1] = gMoveDescription_Placeholder,
    [MOVE_DIRE_CLAW - 1] = gMoveDescription_Placeholder,
    [MOVE_PSYSHIELD_BASH - 1] = gMoveDescription_Placeholder,
    [MOVE_POWER_SHIFT - 1] = gMoveDescription_Placeholder,
    [MOVE_STONE_AXE - 1] = gMoveDescription_Placeholder,
    [MOVE_SPRINGTIDE_STORM - 1] = gMoveDescription_Placeholder,
    [MOVE_MYSTICAL_POWER - 1] = gMoveDescription_Placeholder,
    [MOVE_RAGING_FURY - 1] = gMoveDescription_Placeholder,
    [MOVE_WAVE_CRASH - 1] = gMoveDescription_Placeholder,
    [MOVE_CHLOROBLAST - 1] = gMoveDescription_Placeholder,
    [MOVE_MOUNTAIN_GALE - 1] = gMoveDescription_Placeholder,
    [MOVE_VICTORY_DANCE - 1] = gMoveDescription_Placeholder,
    [MOVE_HEADLONG_RUSH - 1] = gMoveDescription_Placeholder,
    [MOVE_BARB_BARRAGE - 1] = gMoveDescription_Placeholder,
    [MOVE_ESPER_WING - 1] = gMoveDescription_Placeholder,
    [MOVE_BITTER_MALICE - 1] = gMoveDescription_Placeholder,
    [MOVE_SHELTER - 1] = gMoveDescription_Placeholder,
    [MOVE_TRIPLE_ARROWS - 1] = gMoveDescription_Placeholder,
    [MOVE_INFERNAL_PARADE - 1] = gMoveDescription_Placeholder,
    [MOVE_CEASELESS_EDGE - 1] = gMoveDescription_Placeholder,
    [MOVE_BLEAKWIND_STORM - 1] = gMoveDescription_Placeholder,
    [MOVE_WILDBOLT_STORM - 1] = gMoveDescription_Placeholder,
    [MOVE_SANDSEAR_STORM - 1] = gMoveDescription_Placeholder,
    [MOVE_LUNAR_BLESSING - 1] = gMoveDescription_Placeholder,
    [MOVE_TAKE_HEART - 1] = gMoveDescription_Placeholder,
    [MOVE_TERA_BLAST - 1] = gMoveDescription_Placeholder,
    [MOVE_SILK_TRAP - 1] = gMoveDescription_Placeholder,
    [MOVE_AXE_KICK - 1] = gMoveDescription_Placeholder,
    [MOVE_LAST_RESPECTS - 1] = gMoveDescription_Placeholder,
    [MOVE_LUMINA_CRASH - 1] = gMoveDescription_Placeholder,
    [MOVE_ORDER_UP - 1] = gMoveDescription_Placeholder,
    [MOVE_JET_PUNCH - 1] = gMoveDescription_Placeholder,
    [MOVE_SPICY_EXTRACT - 1] = gMoveDescription_Placeholder,
    [MOVE_SPIN_OUT - 1] = gMoveDescription_Placeholder,
    [MOVE_POPULATION_BOMB - 1] = gMoveDescription_Placeholder,
    [MOVE_ICE_SPINNER - 1] = gMoveDescription_Placeholder,
    [MOVE_GLAIVE_RUSH - 1] = gMoveDescription_Placeholder,
    [MOVE_REVIVAL_BLESSING - 1] = gMoveDescription_Placeholder,
    [MOVE_SALT_CURE - 1] = gMoveDescription_Placeholder,
    [MOVE_TRIPLE_DIVE - 1] = gMoveDescription_Placeholder,
    [MOVE_MORTAL_SPIN - 1] = gMoveDescription_Placeholder,
    [MOVE_DOODLE - 1] = gMoveDescription_Placeholder,
    [MOVE_FILLET_AWAY - 1] = gMoveDescription_Placeholder,
    [MOVE_KOWTOW_CLEAVE - 1] = gMoveDescription_Placeholder,
    [MOVE_FLOWER_TRICK - 1] = gMoveDescription_Placeholder,
    [MOVE_TORCH_SONG - 1] = gMoveDescription_Placeholder,
    [MOVE_AQUA_STEP - 1] = gMoveDescription_Placeholder,
    [MOVE_RAGING_BULL - 1] = gMoveDescription_Placeholder,
    [MOVE_MAKE_IT_RAIN - 1] = gMoveDescription_Placeholder,
    [MOVE_RUINATION - 1] = gMoveDescription_Placeholder,
    [MOVE_COLLISION_COURSE - 1] = gMoveDescription_Placeholder,
    [MOVE_ELECTRO_DRIFT - 1] = gMoveDescription_Placeholder,
    [MOVE_SHED_TAIL - 1] = gMoveDescription_Placeholder,
    [MOVE_CHILLY_RECEPTION - 1] = gMoveDescription_Placeholder,
    [MOVE_TIDY_UP - 1] = gMoveDescription_Placeholder,
    [MOVE_SNOWSCAPE - 1] = gMoveDescription_Placeholder,
    [MOVE_POUNCE - 1] = gMoveDescription_Placeholder,
    [MOVE_TRAILBLAZE - 1] = gMoveDescription_Placeholder,
    [MOVE_CHILLING_WATER - 1] = gMoveDescription_Placeholder,
    [MOVE_HYPER_DRILL - 1] = gMoveDescription_Placeholder,
    [MOVE_TWIN_BEAM - 1] = gMoveDescription_Placeholder,
    [MOVE_RAGE_FIST - 1] = gMoveDescription_Placeholder,
    [MOVE_ARMOR_CANNON - 1] = gMoveDescription_Placeholder,
    [MOVE_BITTER_BLADE - 1] = gMoveDescription_Placeholder,
    [MOVE_DOUBLE_SHOCK - 1] = gMoveDescription_Placeholder,
    [MOVE_GIGATON_HAMMER - 1] = gMoveDescription_Placeholder,
    [MOVE_COMEUPPANCE - 1] = gMoveDescription_Placeholder,
    [MOVE_AQUA_CUTTER - 1] = gMoveDescription_Placeholder,
    [MOVE_BLAZING_TORQUE - 1] = gMoveDescription_Placeholder,
    [MOVE_WICKED_TORQUE - 1] = gMoveDescription_Placeholder,
    [MOVE_NOXIOUS_TORQUE - 1] = gMoveDescription_Placeholder,
    [MOVE_COMBAT_TORQUE - 1] = gMoveDescription_Placeholder,
    [MOVE_MAGICAL_TORQUE - 1] = gMoveDescription_Placeholder,
    [MOVE_PSYBLADE - 1] = gMoveDescription_Placeholder,
    [MOVE_HYDRO_STEAM - 1] = gMoveDescription_Placeholder,
    [MOVE_BLOOD_MOON - 1] = gMoveDescription_Placeholder,
    [MOVE_MATCHA_GOTCHA - 1] = gMoveDescription_Placeholder,
    [MOVE_SYRUP_BOMB - 1] = gMoveDescription_Placeholder,
    [MOVE_IVY_CUDGEL - 1] = gMoveDescription_Placeholder,
    [MOVE_ELECTRO_SHOT - 1] = gMoveDescription_Placeholder,
    [MOVE_TERA_STARSTORM - 1] = gMoveDescription_Placeholder,
    [MOVE_FICKLE_BEAM - 1] = gMoveDescription_Placeholder,
    [MOVE_BURNING_BULWARK - 1] = gMoveDescription_Placeholder,
    [MOVE_THUNDERCLAP - 1] = gMoveDescription_Placeholder,
    [MOVE_MIGHTY_CLEAVE - 1] = gMoveDescription_Placeholder,
    [MOVE_TACHYON_CUTTER - 1] = gMoveDescription_Placeholder,
    [MOVE_HARD_PRESS - 1] = gMoveDescription_Placeholder,
    [MOVE_DRAGON_CHEER - 1] = gMoveDescription_Placeholder,
    [MOVE_ALLURING_VOICE - 1] = gMoveDescription_Placeholder,
    [MOVE_TEMPER_FLARE - 1] = gMoveDescription_Placeholder,
    [MOVE_SUPERCELL_SLAM - 1] = gMoveDescription_Placeholder,
    [MOVE_PSYCHIC_NOISE - 1] = gMoveDescription_Placeholder,
    [MOVE_UPPER_HAND - 1] = gMoveDescription_Placeholder,
    [MOVE_MALIGNANT_CHAIN - 1] = gMoveDescription_Placeholder,
};
