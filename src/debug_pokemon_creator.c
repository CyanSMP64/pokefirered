...
//            AddTextPrinterParameterized(sDebugPkmCreatorData.menuWindowId, FONT_SMALL, gStringVar2, x, y, 0, NULL);
//            break;
//        case VAL_SPECIES:
//            ConvertIntToDecimalStringN(gStringVar1, sDebugPkmCreatorData.data[index], STR_CONV_MODE_LEADING_ZEROS, data->digitCount);
//            if (data->text != NULL)
...
//            AddTextPrinterParameterized(sDebugPkmCreatorData.menuWindowId, FONT_SMALL, gStringVar1, x, y, 0, NULL);
//            break;
//        case VAL_TID:
//            ConvertIntToDecimalStringN(gStringVar1, sDebugPkmCreatorData.data[index], STR_CONV_MODE_LEADING_ZEROS, data->digitCount);
//            if (data->text != NULL)
...
//            AddTextPrinterParameterized(sDebugPkmCreatorData.menuWindowId, FONT_SMALL, gStringVar1, x, y, 0, NULL);
//            x = 180;
//            AddTextPrinterParameterized(sDebugPkmCreatorData.menuWindowId, FONT_SMALL, GenderIndexes[sDebugPkmCreatorData.data[VAL_OT_GENDER]], x, y, 0, NULL);
//            break;
//        case VAL_PID:
//            ConvertUIntToHexStringN(gStringVar1, sDebugPkmCreatorData.data[index], STR_CONV_MODE_LEADING_ZEROS, data->digitCount);
//            if (data->text != NULL)
...
//            x = 208;
//            AddTextPrinterParameterized(sDebugPkmCreatorData.menuWindowId, FONT_SMALL, GenderIndexes[sDebugPkmCreatorData.data[VAL_PKM_GENDER]], x, y, 0, NULL);
//            x = 214;
//            AddTextPrinterParameterized(sDebugPkmCreatorData.menuWindowId, FONT_SMALL, IsShinyIndex[sDebugPkmCreatorData.data[VAL_IS_SHINY]], x, y, 0, NULL);
//            break;
//        case VAL_OT_GENDER:
//        case VAL_PKM_GENDER:
...
//            AddTextPrinterParameterized(sDebugPkmCreatorData.menuWindowId, FONT_SMALL, gStringVar2, x, y, 0, NULL);
//            x = 214;
//            AddTextPrinterParameterized(sDebugPkmCreatorData.menuWindowId, FONT_SMALL, IsShinyIndex[isSihny], x, y, 0, NULL);
//            x = 100;
//        }
