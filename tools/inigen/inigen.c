...
const struct StaticPokemon gStaticPokemon[][5] = {
    ...
    {{"ThreeIsland_BerryForest_EventScript_Lostelle", 57, "ThreeIsland_BerryForest_EventScript_Lostelle", 0x44, " // Hypno in Berry Forest"}, {"ThreeIsland_BerryForest_EventScript_Lostelle", 0x42, NULL, 0x0, NULL}},
...
const struct TMText gTMTexts[] = {
    ...
    {39,  6,  2,  1,  0xAC, "A TM, Technical Machine, contains a technique for Pokémon.\\pUsing a TM teaches the move it contains to a Pokémon.\\pA TM is good for only one use.\\pSo, when you use one, pick the Pokémon carefully.\\pAnyways… TM39 contains [move]."},
};
